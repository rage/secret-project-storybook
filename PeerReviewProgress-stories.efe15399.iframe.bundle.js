"use strict";(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[282],{"./stories/PeerReviewProgress.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Primary:()=>Primary,__namedExportsOrder:()=>__namedExportsOrder,default:()=>PeerReviewProgress_stories});__webpack_require__("./node_modules/react/index.js");var emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js"),es=__webpack_require__("./node_modules/react-i18next/dist/es/index.js"),CourseProgress=__webpack_require__("./src/components/CourseProgress/index.tsx"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Wrapper=emotion_styled_browser_esm.A.div`
  width: 100%;
  background: #e9efef;
  ...
  align-items: center;
  margin-bottom: 2rem;
`,PeerReviewProgress=({total,attempt})=>{const{t}=(0,es.Bd)();return(0,jsx_runtime.jsx)(Wrapper,{children:(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.AH`
          flex: 1;
        `,children:(0,jsx_runtime.jsx)(CourseProgress.A,{variant:"bar",exercisesTotal:total,exercisesAttempted:attempt,showAsPercentage:!1,height:"small",label:t("peer-reviews-given")})})})};PeerReviewProgress.displayName="PeerReviewProgress";const PeerReview_PeerReviewProgress=PeerReviewProgress;try{PeerReviewProgress.displayName="PeerReviewProgress",PeerReviewProgress.__docgenInfo={description:"",displayName:"PeerReviewProgress",props:{total:{defaultValue:null,description:"",name:"total",required:!0,type:{name:"number"}},attempt:{defaultValue:null,description:"",name:"attempt",required:!0,type:{name:"number"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/PeerReview/PeerReviewProgress.tsx#PeerReviewProgress"]={docgenInfo:PeerReviewProgress.__docgenInfo,name:"PeerReviewProgress",path:"src/components/PeerReview/PeerReviewProgress.tsx#PeerReviewProgress"})}catch(__react_docgen_typescript_loader_error){}const PeerReviewProgress_stories={parameters:{storySource:{source:'\nimport { Meta, Story } from "@storybook/react"\nimport React from "react"\n\nimport PeerReviewProgress from "../src/components/PeerReview/PeerReviewProgress"\n\nexport default {\n  title: "Components/PeerReview/PeerReviewProgress",\n  component: PeerReviewProgress,\n} as Meta\n\nconst Component = PeerReviewProgress\n\ntype ComponentProps = React.ComponentProps<typeof Component>\n\nconst Template: Story<ComponentProps> = (args: ComponentProps) => <Component {...args} />\n\nexport const Primary: Story<ComponentProps> = Template.bind({})\nPrimary.args = {\n  total: 10,\n  attempt: 2,\n  children: "Option",\n}\n',locationsMap:{primary:{startLoc:{col:40,line:16},endLoc:{col:89,line:16},startBody:{col:40,line:16},endBody:{col:89,line:16}}}}},title:"Components/PeerReview/PeerReviewProgress",component:PeerReview_PeerReviewProgress},Component=PeerReview_PeerReviewProgress,Template=args=>(0,jsx_runtime.jsx)(Component,{...args});Template.displayName="Template";const Primary=Template.bind({});Primary.args={total:10,attempt:2,children:"Option"},Primary.parameters={...Primary.parameters,docs:{...Primary.parameters?.docs,source:{originalSource:"(args: ComponentProps) => <Component {...args} />",...Primary.parameters?.docs?.source}}};const __namedExportsOrder=["Primary"]},"./src/components/CourseProgress/index.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>components_CourseProgress});var react=__webpack_require__("./node_modules/react/index.js"),emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js"),es=__webpack_require__("./node_modules/react-i18next/dist/es/index.js"),react_spring_modern=__webpack_require__("./node_modules/react-spring/dist/react-spring.modern.mjs"),styles=__webpack_require__("./src/styles/index.ts"),respond=__webpack_require__("./src/styles/respond.ts"),constants=__webpack_require__("./src/utils/constants.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const StyledSVG=emotion_styled_browser_esm.A.div`
  position: relative;
  width: 100%;
  text-align: center;
  height: auto;
...
`,CircularProgress=({label,given,max,required})=>{const[willAnimate,setWillAnimate]=(0,react.useState)(!1),{t}=(0,es.Bd)(),givenScore=given??0,maximum=max??0,circumference=2*Math.PI*160,receivedPointsStrokeDashOffset=(1-givenScore/maximum)*circumference,requiredForCompletionStrokeDashOffset=(1-(required&&required>0&&max&&max>0?required/max:0))*circumference;return(0,react.useLayoutEffect)((()=>{const onScroll=()=>{window.scrollY+window.innerHeight>1700&&setWillAnimate(!0)};return window.addEventListener("scroll",onScroll),()=>window.removeEventListener("scroll",onScroll)}),[]),(0,react_spring_modern.zh)({number:willAnimate?givenScore:0,config:{duration:1e3}}),(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)("h2",{className:(0,emotion_css_esm.cx)(constants.JF,emotion_css_esm.AH`
  ...
  display: flex;
  background: ${styles.$7.colors.green[100]};
  border-radius: 100px;
  overflow: hidden;
  align-items: center;
...
`,LinearProgressFill=emotion_styled_browser_esm.A.div`
  height: ${({height})=>"small"===height?"16px":"20px"};
  position: absolute;
  top: 0;
  left: 0;
  ...
  background: ${props=>props.light?styles.$7.colors.yellow[200]:styles.$7.colors.green[600]};
  justify-content: end;

  ${respond.$.sm} {
    height: ${({height})=>"small"===height?"16px":"28px"};
  }
`,Label=emotion_styled_browser_esm.A.div`
  min-width: 100%;
  font-weight: 500;
  margin-right: 1rem;
