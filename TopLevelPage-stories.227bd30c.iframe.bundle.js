"use strict";(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[5103],{"./stories/TopLevelPage.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Primary:()=>Primary,__namedExportsOrder:()=>__namedExportsOrder,default:()=>TopLevelPage_stories});__webpack_require__("./node_modules/react/index.js");var emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js"),next_link=__webpack_require__("./node_modules/next/link.js"),link_default=__webpack_require__.n(next_link);const bulleye_namespaceObject=__webpack_require__.p+"static/media/bulleye.7e72ba00.svg",cross_namespaceObject=__webpack_require__.p+"static/media/cross.17492feb.svg";var styles=__webpack_require__("./src/styles/index.ts"),respond=__webpack_require__("./src/styles/respond.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Content=emotion_styled_browser_esm.A.div`
  margin: 0 auto;
  max-width: 100%;
  background: #ecf3f2;
  display: flex;
...
`,SVGWrapper=emotion_styled_browser_esm.A.div`
  position: absolute;
  width: 90px;
  height: 90px;
  top: ${({isEven})=>isEven?"-48px":"-26px"};
  left: 20px;
`,TopLevelPage=({title,url,index})=>{const isEven=index%2==0;return(0,jsx_runtime.jsx)(link_default(),{href:url,className:emotion_css_esm.AH`
...
//# sourceMappingURL=TopLevelPage-stories.227bd30c.iframe.bundle.js.map