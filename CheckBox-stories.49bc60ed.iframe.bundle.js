...
`,error=emotion_css_esm.iv`
  ...
  margin-top: -15px;
`,CheckBox=({onChange,className,checked,register,...rest})=>(0,jsx_runtime.jsxs)("div",{className:(0,emotion_css_esm.cx)(emotion_css_esm.iv`
          margin-bottom: 1rem;
        `,className),children:[(0,jsx_runtime.jsxs)(Label,{...rest,children:[(0,jsx_runtime.jsx)("input",{type:"checkbox",checked,"aria-errormessage":rest.error?`${rest.label}_error`:void 0,"aria-invalid":void 0!==rest.error,onChange:({target:{checked}})=>{onChange&&onChange(checked)},...register,...rest}),(0,jsx_runtime.jsx)("span",{children:rest.label})]}),rest.error&&(0,jsx_runtime.jsx)("span",{className:rest.error?(0,emotion_css_esm.cx)(error):emotion_css_esm.iv`
                  visibility: hidden;
                  height: 0;
                  display: block;
                `,id:`${rest.id??rest.label}_error`,role:"alert",children:"Please check the secret box"})]});CheckBox.displayName="CheckBox";const InputFields_CheckBox=CheckBox;try{CheckBox.displayName="CheckBox",CheckBox.__docgenInfo={description:"",displayName:"CheckBox",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},error:{defaultValue:null,description:"",name:"error",required:!1,type:{name:"boolean"}},checked:{defaultValue:null,description:"",name:"checked",required:!1,type:{name:"boolean"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!1,type:{name:"((checked: boolean, name?: string) => void)"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},register:{defaultValue:null,description:"",name:"register",required:!1,type:{name:"UseFormRegisterReturn"}},id:{defaultValue:null,description:"",name:"id",required:!1,type:{name:"string"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/InputFields/CheckBox.tsx#CheckBox"]={docgenInfo:CheckBox.__docgenInfo,name:"CheckBox",path:"src/components/InputFields/CheckBox.tsx#CheckBox"})}catch(__react_docgen_typescript_loader_error){}const CheckBox_stories={parameters:{storySource:{source:'\nimport { Meta, Story } from "@storybook/react";\nimport React from "react";\nimport CheckBox from "../src/components/InputFields/CheckBox";\nexport default ({\n  title: "Components/CheckBox",\n  component: CheckBox\n} as Meta);\nconst Component = CheckBox;\ntype ComponentProps = React.ComponentProps<typeof Component>;\nconst Template: Story<ComponentProps> = (args: ComponentProps) => <Component {...args} />;\nexport const Check: Story<ComponentProps> = Template.bind({});\nCheck.args = {\n  label: "Field Label",\n  error: false,\n  checked: true\n};\nCheck.parameters = {\n  ...Check.parameters,\n  docs: {\n    ...Check.parameters?.docs,\n    source: {\n      originalSource: "(args: ComponentProps) => <Component {...args} />",\n      ...Check.parameters?.docs?.source\n    }\n  }\n};',locationsMap:{check:{startLoc:{col:40,line:11},endLoc:{col:89,line:11},startBody:{col:40,line:11},endBody:{col:89,line:11}}}}},title:"Components/CheckBox",component:InputFields_CheckBox},Component=InputFields_CheckBox,Template=args=>(0,jsx_runtime.jsx)(Component,{...args});Template.displayName="Template";const Check=Template.bind({});Check.args={label:"Field Label",error:!1,checked:!0},Check.parameters={...Check.parameters,docs:{...Check.parameters?.docs,source:{originalSource:"(args: ComponentProps) => <Component {...args} />",...Check.parameters?.docs?.source}}};const __namedExportsOrder=["Check"]}}]);
//# sourceMappingURL=CheckBox-stories.49bc60ed.iframe.bundle.js.map