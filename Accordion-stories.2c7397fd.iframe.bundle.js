"use strict";(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[3982],{"./stories/Accordion.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Detail:()=>Detail,Simple:()=>Simple,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Accordion_stories});__webpack_require__("./node_modules/react/index.js");var emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js"),styles=__webpack_require__("./src/styles/index.ts"),respond=__webpack_require__("./src/styles/respond.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const openAnimation=emotion_css_esm.F4`
0% { opacity: 0; }
100% { opacity: 1; }
`,slideDown=emotion_css_esm.F4`
from { opacity: 0; height: 0; padding: 0;}
to { opacity: 1; height: 100%; padding: 10px;}
`,TextWrapper=emotion_styled_browser_esm.Z.div`
  padding: 0;
  margin: 0;
...
`,DetailAccordion=props=>props.children?(0,jsx_runtime.jsx)(TextWrapper,{children:props.children}):(0,jsx_runtime.jsx)("div",{children:(0,jsx_runtime.jsx)(TextWrapper,{children:(0,jsx_runtime.jsxs)("details",{children:[(0,jsx_runtime.jsx)("summary",{children:"This is a heading:"}),(0,jsx_runtime.jsx)("ul",{children:(0,jsx_runtime.jsx)("li",{children:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown\nprinter took a galley of type and scrambled it to make a type specimen book. It has\nsurvived not only five centuries, but also the leap into electronic typesetting,\nremaining essentially unchanged. It was popularised in the 1960s with the release of\nLetraset sheets containing Lorem Ipsum passages, and more recently with desktop\npublishing software like Aldus PageMaker including versions of Lorem Ipsum"})})]})})});DetailAccordion.displayName="DetailAccordion";const Accordion_DetailAccordion=DetailAccordion;try{DetailAccordion.displayName="DetailAccordion",DetailAccordion.__docgenInfo={description:"",displayName:"DetailAccordion",props:{}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/Accordion/DetailAccordion.tsx#DetailAccordion"]={docgenInfo:DetailAccordion.__docgenInfo,name:"DetailAccordion",path:"src/components/Accordion/DetailAccordion.tsx#DetailAccordion"})}catch(__react_docgen_typescript_loader_error){}const Accordion_openAnimation=emotion_css_esm.F4`
0% { opacity: 0; }
100% { opacity: 1; }
`,Accordion_slideDown=emotion_css_esm.F4`
from { opacity: 0; height: 0; padding: 0;}
to { opacity: 1; height: 100%; padding: 10px;}
`,Accordion_TextWrapper=emotion_styled_browser_esm.Z.div`
  padding: 0;
  margin: 0;
  ...
  details summary {
    padding: 1rem 0;
    border-bottom: 1px solid ${styles.wE.colors.gray[700]};
    position: relative;
    cursor: pointer;
    font-size: 1.25rem;
    font-weight: medium;
