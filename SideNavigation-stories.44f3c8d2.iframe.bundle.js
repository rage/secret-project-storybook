...
`,PlaceholderAvatar=emotion_styled_browser_esm.c.div`
  background: #dddee0;
  border-radius: 100%;
  height: 34px;
  width: 34px;
  margin-right: 15px;
`,StyledButton=emotion_styled_browser_esm.c.button`
  display: flex;
  border: none;
  ...
  color: #313947;
  width: 21rem;
`,ListItem=emotion_styled_browser_esm.c.li`
  margin-left: 2rem;
...
//# sourceMappingURL=SideNavigation-stories.44f3c8d2.iframe.bundle.js.map