...
`,Tag=emotion_styled_browser_esm.c.div`
  background: #ececec;
  width: auto;
  padding: 1rem;
...
`,Content=emotion_styled_browser_esm.c.div`
  padding: 0 2rem;
`,Text=emotion_styled_browser_esm.c.p`
  font-size: 20px;
  line-height: 140%;
  font-weight: 500;
  padding-bottom: 3rem;
  border-bottom: 2px solid rgba(197, 197, 197, 0.8);
`,Footer=emotion_styled_browser_esm.c.div`
  display: flex;
  justify-content: space-between;
  padding: 1.5rem 0 3rem 0;
  align-items: center;
`,Author=emotion_styled_browser_esm.c.div`
  display: flex;
...
`,ChatIcon=emotion_styled_browser_esm.c.div`
  display: flex;
...
//# sourceMappingURL=Threads-stories.e0a8d52f.iframe.bundle.js.map