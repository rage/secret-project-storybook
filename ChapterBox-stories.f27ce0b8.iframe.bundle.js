...
`,PageNumberBox=emotion_styled_browser_esm.A.div`
  ...
  height: 24px;
  border-radius: 50%;
  background: ${styles.$7.colors.blue[200]};
  margin-right: 8px;

  span {
    color: ${styles.$7.colors.gray[700]};
    font-family: ${styles.jV};
    line-height: 1;
    font-size: 12px !important;
    text-align: center;
    font-weight: 600;
  }
`,ChapterParts=emotion_styled_browser_esm.A.div`
  margin-left: 0em;
  padding: 0.8em 1em;
  ...
  svg {
    ...
    right: 30px;
    top: 40%;
    fill: ${styles.$7.colors.gray[300]};
  }

  :hover svg {
    fill: ${styles.$7.colors.gray[600]};
  }
...
`,PagesInChapterBox=props=>(0,jsx_runtime.jsx)(Wrapper,{children:(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:(0,jsx_runtime.jsx)(link_default(),{href:props.url,className:emotion_css_esm.AH`
            color: #1c3b40;
            box-shadow: none;
            text-decoration: none;
            &:focus-visible {
...
//# sourceMappingURL=ChapterBox-stories.f27ce0b8.iframe.bundle.js.map