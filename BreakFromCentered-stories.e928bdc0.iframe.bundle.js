"use strict";(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[7220],{"./stories/BreakFromCentered.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,WithSidebarOnLeft:()=>WithSidebarOnLeft,WithSidebarOnRight:()=>WithSidebarOnRight,__namedExportsOrder:()=>__namedExportsOrder,default:()=>BreakFromCentered_stories});var emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),jsx_runtime=(__webpack_require__("./node_modules/react/index.js"),__webpack_require__("./node_modules/react/jsx-runtime.js"));const BreakFromCentered=props=>{let scrollbarWidth=0;return"undefined"!=typeof window&&(scrollbarWidth=Math.abs(window.innerWidth-document.documentElement.clientWidth)/2),props.sidebar?props.sidebarThreshold?(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.gV`
            position: relative;
            left: 50%;
            right: 50%;
          ...
          `,children:props.children}):(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.gV`
            position: relative;
            left: 50%;
            right: 50%;
            margin-left: calc(-50vw + ${props.sidebarWidth} / 2);
    ...
    `,children});Wrapper.displayName="Wrapper";const DefaultTemplate=args=>(0,jsx_runtime.jsx)(Wrapper,{children:(0,jsx_runtime.jsxs)(Centered.cp,{variant:"narrow",children:[children,(0,jsx_runtime.jsx)(Component,{...args}),children]})});DefaultTemplate.displayName="DefaultTemplate";const Default=DefaultTemplate.bind({});Default.args={children:(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.gV`
      ...
      `,children:(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.gV`
          ...
          position: relative;
          bottom: -80px;
        `,children:"Sidebar"})}),(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.gV`
        margin-left: 20rem;
      `,children:(0,jsx_runtime.jsxs)(Centered.cp,{variant:"narrow",children:[children,(0,jsx_runtime.jsx)(Component,{...args}),children]})})]});WithSidebarOnLeftTemplate.displayName="WithSidebarOnLeftTemplate";const WithSidebarOnLeft=WithSidebarOnLeftTemplate.bind({});WithSidebarOnLeft.args={sidebar:!0,sidebarPosition:"left",sidebarWidth:"20rem",children:(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.gV`
        background-color: #fffff0;
        padding: 1rem 0.5rem;
        border: 1px solid #333;
      `,children:"This content should have broken free from the centering."})};const WithSidebarOnRightTemplate=args=>(0,jsx_runtime.jsxs)(Wrapper,{children:[(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.gV`
        width: 20rem;
        height: 100vh;
        position: absolute;
        right: 0;
...
//# sourceMappingURL=BreakFromCentered-stories.e928bdc0.iframe.bundle.js.map