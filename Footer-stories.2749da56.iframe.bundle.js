"use strict";(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[3616],{"./stories/Footer.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Primary:()=>Primary,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Footer_stories});__webpack_require__("./node_modules/react/index.js");var emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js"),es=__webpack_require__("./node_modules/react-i18next/dist/es/index.js");const UHBrandLogo_namespaceObject=__webpack_require__.p+"static/media/UHBrandLogo.352b4f75.svg";var moocfiLogo=__webpack_require__("./src/img/moocfiLogo.svg"),styles=__webpack_require__("./src/styles/index.ts"),respond=__webpack_require__("./src/styles/respond.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Container=emotion_styled_browser_esm.c.div`
  margin-top: 5em;
  padding: 1rem;
  background: #f7f8f9;
...
`,Wrapper=emotion_styled_browser_esm.c.div`
  display: grid;
...
`,StyledLink=emotion_styled_browser_esm.c.a`
...
`,Links=emotion_styled_browser_esm.c.div`
  display: flex;
  flex-direction: column;
`,LogoA=emotion_styled_browser_esm.c.a`
...
`,Footer=()=>{const{t,i18n}=(0,es.Gy)(),useFinnishLinks="fi"===i18n.language||"fi-FI"===i18n.language;return(0,jsx_runtime.jsx)("footer",{role:"contentinfo",className:emotion_css_esm.gV`
        margin-top: 2rem;
...
//# sourceMappingURL=Footer-stories.2749da56.iframe.bundle.js.map