...
`,Label=emotion_styled_browser_esm.A.span`
  ...
  opacity: 0.5;
  font-size: 16px;
`,RadioSection=emotion_styled_browser_esm.A.div`
  display: flex;
  margin-top: 0.2rem;
  margin-bottom: 1rem;
`,StyledButton=emotion_styled_browser_esm.A.input`
  display: flex;
  border: none;
  align-self: end;
  padding: 0.5rem 2rem;
...
`,Content=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.div`
  padding: 0 2rem;
`,Text=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.p`
  font-size: 20px;
  line-height: 140%;
  font-weight: 500;
  padding-bottom: 0rem;
`,Footer=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.div`
  display: flex;
  justify-content: space-between;
  padding: 1.5rem 0 3rem 0;
  align-items: center;
`,Author=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.div`
  display: flex;
...
`,ActionTab=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.div`
  display: flex;
`,ChatIcon=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.div`
  display: flex;
`,PlaceholderAvatar=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.div`
  background: #f3f3f3;
  border-radius: 100%;
  height: 35px;
  width: 35px;
  margin-right: 10px;
`,PlaceholderIcon=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.div`
  background: #f3f3f3;
  border-radius: 100%;
  height: 30px;
  width: 30px;
  margin-right: 10px;
`,StyledReplyIcon=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.div`
  display: flex;
  margin: 0 1.5rem;
  cursor: pointer;
...
`,StyledReportIcon=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.span`
  color: #b66757;
`,TimeLabel=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.span`
  color: #535a66;
`,StyledButton=_emotion_styled__WEBPACK_IMPORTED_MODULE_1__.A.input`
  display: flex;
  border: none;
  align-self: end;
  padding: 0.5rem 2rem;
...
`,Thread=props=>{const{state:{items}}=props;return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react__WEBPACK_IMPORTED_MODULE_2__.Fragment,{children:[GetThread(props),items?.map((item=>GetNestedThread(item)))]})};Thread.displayName="Thread";const GetThread=props=>{const{t}=(0,react_i18next__WEBPACK_IMPORTED_MODULE_3__.Bd)(),{state,author,handleReply,handleClick,clicked,selectedId}=props,{id,text,time}=state;return text&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(Wrapper,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(Header,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(Author,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(PlaceholderAvatar,{}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span",{children:author})]}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(TimeLabel,{children:time})]}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(Content,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Text,{children:text}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(Footer,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(ActionTab,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(PlaceholderIcon,{}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(PlaceholderIcon,{}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(PlaceholderIcon,{}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(StyledReplyIcon,{onClick:handleClick,children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(PlaceholderIcon,{}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span",{id,children:t("reply")})]}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(StyledReportIcon,{children:t("report")})]}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(ChatIcon,{children:(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(PlaceholderIcon,{})})]}),clicked&&selectedId===id&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("form",{onSubmit:handleReply,children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_InputFields_TextAreaField__WEBPACK_IMPORTED_MODULE_4__.A,{name:"reply",placeholder:t("leave-a-comment"),onChange:()=>null}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(StyledButton,{type:"submit",name:"submit",value:t("reply")})]})]})]},text)},GetNestedThread=item=>{const{t}=(0,react_i18next__WEBPACK_IMPORTED_MODULE_3__.Bd)(),{text,time,author}=item;return text&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(Wrapper,{className:_emotion_css__WEBPACK_IMPORTED_MODULE_0__.AH`
  ...
  input[type="radio"]::before {
    ...
    background-color: ${_styles__WEBPACK_IMPORTED_MODULE_1__.$7.colors.green[600]};
  }
...
`,RadioField=({onChange,className,label,...rest})=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div",{className:(0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.cx)(_emotion_css__WEBPACK_IMPORTED_MODULE_0__.AH`
          margin-bottom: 1rem;
          margin-top: 1rem;
...
//# sourceMappingURL=Forum-stories.7297db61.iframe.bundle.js.map