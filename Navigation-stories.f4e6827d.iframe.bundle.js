...
`,components_SkipLink=SkipLink;try{SkipLink.displayName="SkipLink",SkipLink.__docgenInfo={description:"",displayName:"SkipLink",props:{theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"Theme"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"ElementType<any>"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/SkipLink.tsx#SkipLink"]={docgenInfo:SkipLink.__docgenInfo,name:"SkipLink",path:"src/components/SkipLink.tsx#SkipLink"})}catch(__react_docgen_typescript_loader_error){}const StyledIcon=emotion_css_esm.iv`
  font-size: 1.8rem;
  transform: scale(0.7);

  path {
    fill: ${styles.wE.colors.gray[600]} !important;
  }
