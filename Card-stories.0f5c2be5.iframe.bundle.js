"use strict";(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[1478],{"./stories/Card.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{IllustrationCard:()=>Card_stories_IllustrationCard,Simple:()=>Simple,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Card_stories});__webpack_require__("./node_modules/react/index.js");var emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),styles=__webpack_require__("./src/styles/index.ts"),process=__webpack_require__("./node_modules/process/browser.js");var emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js"),es=__webpack_require__("./node_modules/react-i18next/dist/es/index.js"),constants=__webpack_require__("./src/styles/constants.ts"),respond=__webpack_require__("./src/styles/respond.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const styledspan=emotion_css_esm.iv`
  font-family: ${styles.Qj} !important;
  font-size: 0.9rem;
  opacity: 0.8;
  text-transform: uppercase;
`,CardOpensText=({open,date,time})=>{const{t}=(0,es.$G)();return date&&time?(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)("div",{className:(0,emotion_css_esm.cx)(styledspan),children:t("available")}),(0,jsx_runtime.jsx)("div",{children:t("on-date-at-time",{date,time})})]}):time?(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)("div",{className:(0,emotion_css_esm.cx)(styledspan),children:t("opens-in")}),(0,jsx_runtime.jsx)("div",{children:time})]}):open?(0,jsx_runtime.jsx)("span",{className:(0,emotion_css_esm.cx)(styledspan),children:t("opens-now")}):(0,jsx_runtime.jsx)("span",{children:t("closed")})},Card_CardOpensText=CardOpensText;try{CardOpensText.displayName="CardOpensText",CardOpensText.__docgenInfo={description:"",displayName:"CardOpensText",props:{open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean | undefined"}},date:{defaultValue:null,description:"",name:"date",required:!0,type:{name:"string | undefined"}},time:{defaultValue:null,description:"",name:"time",required:!0,type:{name:"string | undefined"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/Card/CardOpensText.tsx#CardOpensText"]={docgenInfo:CardOpensText.__docgenInfo,name:"CardOpensText",path:"src/components/Card/CardOpensText.tsx#CardOpensText"})}catch(__react_docgen_typescript_loader_error){}const CardOpensTextOverlay=({open,date,time})=>(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
        position: relative;
      `,children:!open&&(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
            flex: 0 1 auto;
            text-align: center;
            background: #e2e4e6;
            padding: 1rem 2rem;
...
`,IllustrationCard=({title,chapterNumber,bg,backgroundImage,open,date,time})=>{const{t}=(0,es.$G)();return(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
        max-width: ${constants.y$}rem;
        border-radius: 1px;
        position: relative;
        ...
        aspect-ratio: 1/1;
        padding: 10px;
      `,children:(0,jsx_runtime.jsxs)(CardContentWrapper,{bg,children:[(0,jsx_runtime.jsx)(Card_CardOpenTextOverlay,{open,date,time}),(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
            width: 100%;
            height: 370.6px;
          ...
          `}),(0,jsx_runtime.jsxs)("div",{className:emotion_css_esm.iv`
            flex: 1 1 auto;
            padding: 1rem;
            position: relative;
            background: #fff;
          ...
          `,children:[(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
            ...
            `,children:(0,jsx_runtime.jsx)("span",{className:emotion_css_esm.iv`
                font-family: ${styles.$O};
                min-width: 18px;
                font-weight: 500;
                color: ${styles.wE.colors.blue[600]} !important;
                background: #edf1f4;
...
`,StyledSVG=Image=>(0,jsx_runtime.jsx)(Image,{className:emotion_css_esm.iv`
        position: absolute;
        z-index: 99;
        left: 50%;
        top: 50%;
        transform: translate(-50%, -50%);
      `});StyledSVG.displayName="StyledSVG";const SimpleCard=({title,chapterNumber,open,date,time,bg,backgroundImage})=>{const{t}=(0,es.$G)();return(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
        max-width: ${constants.y$}rem;
        border-radius: 1px;
        position: relative;
        transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1);
        background: #48cfad;
        aspect-ratio: 1/1;
      `,children:(0,jsx_runtime.jsxs)(SimpleCard_CardContentWrapper,{bg,children:[backgroundImage&&StyledSVG(backgroundImage),(0,jsx_runtime.jsx)(Card_CardOpenTextOverlay,{open,date,time}),open&&(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
              padding: 2rem;
              ${respond.L.lg} {
                padding: 3rem;
              }
            `,children:(0,jsx_runtime.jsx)(StCardSvg,{})}),(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
            flex: 1;
          `}),(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.iv`
            flex: 1 1 auto;
