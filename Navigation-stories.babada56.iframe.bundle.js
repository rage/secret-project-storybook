(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[517],{"./stories/Navigation.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Complex:()=>Complex,Simple:()=>Simple,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Navigation_stories});var react=__webpack_require__("./node_modules/react/index.js"),emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),es=__webpack_require__("./node_modules/react-i18next/dist/es/index.js"),moocfiLogo=__webpack_require__("./src/img/moocfiLogo.svg"),styles=__webpack_require__("./src/styles/index.ts"),respond=__webpack_require__("./src/styles/respond.ts"),accessibility=__webpack_require__("./src/utils/accessibility.ts"),Button=__webpack_require__("./src/components/Button.tsx"),QueryClientProvider=__webpack_require__("./node_modules/@tanstack/react-query/build/modern/QueryClientProvider.js"),useQuery=__webpack_require__("./node_modules/@tanstack/react-query/build/modern/useQuery.js"),ErrorBanner=__webpack_require__("./src/components/ErrorBanner.tsx"),components_Spinner=__webpack_require__("./src/components/Spinner.tsx"),lib_axios=__webpack_require__("./node_modules/axios/lib/axios.js");const loggedIn=async()=>(await lib_axios.A.get("/api/v0/auth/logged-in",{responseType:"json"})).data;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const defaultLoginState={isPending:!1,refresh:async()=>{},signedIn:null},LoginStateContext=react.createContext(defaultLoginState),contexts_LoginStateContext=LoginStateContext,LoginStateContextProvider=({children})=>{const[loginState,setLoginState]=(0,react.useState)(defaultLoginState),isLoggedIn=(0,useQuery.I)({queryKey:["logged-in"],queryFn:loggedIn});return(0,react.useEffect)((()=>{setLoginState((prev=>({...prev,isPending:isLoggedIn.isPending,refresh:isLoggedIn.refetch,signedIn:isLoggedIn.data})))}),[isLoggedIn.data,isLoggedIn.isPending,isLoggedIn.refetch]),isLoggedIn.isError?(0,jsx_runtime.jsx)(ErrorBanner.A,{variant:"readOnly",error:isLoggedIn.error}):(0,jsx_runtime.jsx)(LoginStateContext.Provider,{value:loginState,children})};function withSignedIn(Component){const displayName=Component.displayName||Component.name||"Component",InnerComponent=props=>{const{t}=useTranslation(),loginStateContext=useContext(LoginStateContext);if(loginStateContext.isPending||null===loginStateContext.signedIn)return _jsx(Spinner,{variant:"medium"});if(!loginStateContext.signedIn){const returnTo=encodeURIComponent(window.location.pathname);return window.location.replace(`/login?return_to=${returnTo}`),_jsx("div",{children:t("please-sign-in-to-view-this-page")})}return _jsx(Component,{...props})};return InnerComponent.displayName=`withSignedIn(${displayName})`,InnerComponent}LoginStateContextProvider.displayName="LoginStateContextProvider";try{withSignedIn.displayName="withSignedIn",withSignedIn.__docgenInfo={description:"",displayName:"withSignedIn",props:{}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/contexts/LoginStateContext.tsx#withSignedIn"]={docgenInfo:withSignedIn.__docgenInfo,name:"withSignedIn",path:"src/contexts/LoginStateContext.tsx#withSignedIn"})}catch(__react_docgen_typescript_loader_error){}try{LoginStateContextProvider.displayName="LoginStateContextProvider",LoginStateContextProvider.__docgenInfo={description:"",displayName:"LoginStateContextProvider",props:{}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/contexts/LoginStateContext.tsx#LoginStateContextProvider"]={docgenInfo:LoginStateContextProvider.__docgenInfo,name:"LoginStateContextProvider",path:"src/contexts/LoginStateContext.tsx#LoginStateContextProvider"})}catch(__react_docgen_typescript_loader_error){}var next_router=__webpack_require__("./node_modules/next/router.js");var process=__webpack_require__("./node_modules/process/browser.js");function useCurrentPagePathForReturnTo(currentPagePath){const uncheckedReturnTo=function useQueryParameter(name){const router=(0,next_router.useRouter)(),routerReady=router.isReady;return(0,react.useMemo)((()=>{if(!routerReady)return"";const value=router?.query[name];return value?value instanceof Array?value.join("/"):value.toString():""}),[name,router?.query,routerReady])}("return_to");return currentPagePath.startsWith("/login")||currentPagePath.startsWith("/signup")?uncheckedReturnTo&&""!==uncheckedReturnTo?uncheckedReturnTo:"/":process.env.NEXT_PUBLIC_BASE_PATH+currentPagePath}try{useCurrentPagePathForReturnTo.displayName="useCurrentPagePathForReturnTo",useCurrentPagePathForReturnTo.__docgenInfo={description:"",displayName:"useCurrentPagePathForReturnTo",props:{}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/utils/redirectBackAfterLoginOrSignup.tsx#useCurrentPagePathForReturnTo"]={docgenInfo:useCurrentPagePathForReturnTo.__docgenInfo,name:"useCurrentPagePathForReturnTo",path:"src/utils/redirectBackAfterLoginOrSignup.tsx#useCurrentPagePathForReturnTo"})}catch(__react_docgen_typescript_loader_error){}function loginRoute(returnTo){return`/login?return_to=${encodeURIComponent(returnTo)}`}function signUpRoute(returnTo){return`/signup?return_to=${encodeURIComponent(returnTo)}`}const LoginControls=({styles,currentPagePath})=>{const{t}=(0,es.Bd)(),loginStateContext=(0,react.useContext)(contexts_LoginStateContext),returnTo=useCurrentPagePathForReturnTo(currentPagePath),queryClient=(0,QueryClientProvider.jE)();if(loginStateContext.isPending)return(0,jsx_runtime.jsx)(components_Spinner.A,{variant:"large"});return loginStateContext.signedIn?(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:(0,jsx_runtime.jsx)("li",{className:(0,emotion_css_esm.cx)(styles),children:(0,jsx_runtime.jsx)(Button.Ay,{size:"medium",variant:"primary",onClick:async()=>{await(async()=>{await lib_axios.A.post("/api/v0/auth/logout")})(),queryClient.removeQueries(),await loginStateContext.refresh(),setTimeout((()=>{queryClient.refetchQueries()}),100)},children:t("log-out")})})}):(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)("li",{className:(0,emotion_css_esm.cx)(styles),children:(0,jsx_runtime.jsx)("a",{href:signUpRoute(returnTo),children:(0,jsx_runtime.jsx)(Button.Ay,{size:"medium",variant:"primary",children:t("create-new-account")})})}),(0,jsx_runtime.jsx)("li",{className:(0,emotion_css_esm.cx)(styles),children:(0,jsx_runtime.jsx)("a",{href:loginRoute(returnTo),children:(0,jsx_runtime.jsx)(Button.Ay,{size:"medium",variant:"primary",children:t("log-in")})})})]})},components_LoginControls=LoginControls;try{LoginControls.displayName="LoginControls",LoginControls.__docgenInfo={description:"",displayName:"LoginControls",props:{styles:{defaultValue:null,description:"",name:"styles",required:!1,type:{name:"ClassNamesArg[]"}},currentPagePath:{defaultValue:null,description:"",name:"currentPagePath",required:!0,type:{name:"string"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/LoginControls.tsx#LoginControls"]={docgenInfo:LoginControls.__docgenInfo,name:"LoginControls",path:"src/components/LoginControls.tsx#LoginControls"})}catch(__react_docgen_typescript_loader_error){}var emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js");const getBarColor=({barColor})=>`background-color: ${barColor};`,getLayerHeight=buttonWidth=>.1*buttonWidth,getLayerSpacing=buttonWidth=>.15*buttonWidth,getLinesCommon=({buttonWidth})=>`\n  width: ${buttonWidth}px;\n  height: ${.1*buttonWidth}px;\n  border-radius: ${.1*buttonWidth}px;\n  position: absolute;\n  transition-property: transform;\n  transition-duration: 0.15s;\n  transition-timing-function: ease;\n`,StyledLines=emotion_styled_browser_esm.A.span`
  display: block;
  top: 50%;
...
`,StyledLinesSpring=(0,emotion_styled_browser_esm.A)(StyledLines)`
  &::before {
...
`,StyledButton=emotion_styled_browser_esm.A.div`
...
`,navbarItems=emotion_css_esm.AH`
  position: relative;
  display: flex;
  height: 90px;
  align-items: center;
  ...
  padding: 0em 4em;
  background: ${styles.$7.colors.clear[100]};
...
`,ComplexNav_active=emotion_css_esm.AH`
  left: 0;
  opacity: 1;
...
`,navLinks=emotion_css_esm.AH`
  ...
  &:after {
    ...
    bottom: 0;
    left: 0;
    background-color: ${styles.$7.colors.gray[700]};
...
`,hide=emotion_css_esm.AH`
  ${respond.$.lg} {
    display: none;
  }
`,secondaryLink=emotion_css_esm.AH`
  display: none;
  grid-gap: 10px;
  list-style: none;
  text-align: center;
...
`,MenuIcon=emotion_css_esm.AH`
  &:focus-visible {
    outline: 2px solid ${styles.$7.colors.green[500]};
    outline-offset: 2px;
  }
`,ToolTip=emotion_css_esm.AH`
  background: #fff;
  border-color: #cacaca;
  padding: 0;
  border-radius: 4px;
...
`,components_SkipLink=SkipLink;try{SkipLink.displayName="SkipLink",SkipLink.__docgenInfo={description:"",displayName:"SkipLink",props:{theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"Theme"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"ElementType<any>"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/SkipLink.tsx#SkipLink"]={docgenInfo:SkipLink.__docgenInfo,name:"SkipLink",path:"src/components/SkipLink.tsx#SkipLink"})}catch(__react_docgen_typescript_loader_error){}const StyledIcon=emotion_css_esm.AH`
  font-size: 1.8rem;
  transform: scale(0.7);

  path {
    fill: ${styles.$7.colors.gray[600]} !important;
  }
`,Navbar=emotion_css_esm.AH`
  height: 90px;
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  ...
  font-size: 1rem;
  padding: 0 1.4rem;
  margin-bottom: ${constants.fI};
  border-bottom: 2px solid ${styles.$7.colors.gray[100]};
