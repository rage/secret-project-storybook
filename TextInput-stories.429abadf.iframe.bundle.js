"use strict";(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[8748],{"./stories/TextInput.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Text:()=>Text,__namedExportsOrder:()=>__namedExportsOrder,default:()=>TextInput_stories});var react=__webpack_require__("./node_modules/react/index.js"),emotion_css_esm=__webpack_require__("./node_modules/@emotion/css/dist/emotion-css.esm.js"),emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js"),es=__webpack_require__("./node_modules/react-i18next/dist/es/index.js"),styles=__webpack_require__("./src/styles/index.ts"),typography=__webpack_require__("./src/styles/typography.ts");function errorToDescription(error){return void 0===error?null:"string"==typeof error?error:error.message??error.type}var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const ERRORCOLOR=styles.sn.colors.red[600],Input=emotion_styled_browser_esm.c.input`
  background: #fcfcfc;
  border-width: 1.6px;
  border-style: solid;
  border-radius: 3px;
...
`,errorClass=emotion_css_esm.gV`
  color: ${styles.sn.colors.red[600]};
  font-size: 14px;
  display: inline-block;
`,TextField=(0,react.forwardRef)((({onChange,onChangeByValue,className,disabled,error,...rest},ref)=>{const{t}=(0,es.Gy)();return(0,jsx_runtime.jsxs)("div",{className:(0,emotion_css_esm.cx)(emotion_css_esm.gV`
            margin-bottom: 1rem;
            ${disabled&&"cursor: not-allowed;\n            filter: opacity(0.5);"}
          `,className),children:[(0,jsx_runtime.jsxs)("label",{"aria-label":`${rest.label}${!0===rest.required&&` (${t("required")})`}`,className:(0,emotion_css_esm.cx)(emotion_css_esm.gV`
              color: #333;
              font-family: ${typography.qc};
              font-weight: 500;
              font-size: 14px;
              display: block;
              margin-bottom: 2px;
              ${disabled&&`color: ${styles.sn.colors.gray[400]};`}
              ${disabled&&"cursor: not-allowed;"}
            `,rest.labelStyle),children:[rest.label&&(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[rest.label," ",!0===rest.required&&" *"]}),(0,jsx_runtime.jsx)(Input,{id:rest.id,name:rest.name,disabled,colorField:"color"===rest.type,"aria-errormessage":`${rest.id??rest.label}_error`,"aria-invalid":void 0!==error,onChange:event=>{if(onChangeByValue){const{target:{value}}=event;onChangeByValue(value)}onChange&&onChange(event)},defaultValue:rest.defaultValue,error:errorToDescription(error)??void 0,ref,...rest})]}),(0,jsx_runtime.jsx)("span",{className:error?(0,emotion_css_esm.cx)(errorClass):emotion_css_esm.gV`
                  visibility: hidden;
...
//# sourceMappingURL=TextInput-stories.429abadf.iframe.bundle.js.map