"use strict";(self.webpackChunkshared_module=self.webpackChunkshared_module||[]).push([[6532],{"./stories/Quote.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{BlockQuote:()=>BlockQuote,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Quote_stories});__webpack_require__("./node_modules/react/index.js");var emotion_styled_browser_esm=__webpack_require__("./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js");const quote_namespaceObject=__webpack_require__.p+"static/media/quote.31ddc7f8.svg";var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Justify=emotion_styled_browser_esm.c.div`
  display: grid;
  justify-content: center;
`,StyledImg=emotion_styled_browser_esm.c.div`
  position: absolute;
  width: 40px;
  top: 40px;
  left: 46px;
  opacity: 0.15;
`,ContentWrapper=emotion_styled_browser_esm.c.div`
  padding: 0.5rem 2rem;
  margin: 2.5rem 0;
  max-width: 650px;
...
//# sourceMappingURL=Quote-stories.a286a2f7.iframe.bundle.js.map