...
`,StyledLink=(0,emotion_styled_browser_esm.A)(link_default())`
  border: 1px solid ${styles.$7.colors.blue[200]};
  padding: 0.3rem 1rem;
  background: #fff;
  ...
  span {
    ...
    font-weight: 500;
    padding-left: 8px;
    color: ${styles.$7.colors.blue[700]};
  }

  .arrow {
    fill: ${styles.$7.colors.blue[500]};
  }

  &:hover {
    cursor: pointer;
    background: ${styles.$7.colors.blue[100]};

    span {
      color: ${styles.$7.colors.blue[600]};
    }

    .arrow {
      fill: ${styles.$7.colors.blue[600]};
    }
  }
`,NextSectionLink=({title,subtitle,nextTitle,url,previous,chapterFrontPageURL})=>{const{t}=(0,es.Bd)();return(0,jsx_runtime.jsx)(Wrapper,{children:(0,jsx_runtime.jsxs)("div",{className:emotion_css_esm.AH`
          font-family: ${styles.ec};
          min-height: auto;
          max-width: 48rem;
          margin-left: auto;
          margin-right: auto;
        `,children:[chapterFrontPageURL&&(0,jsx_runtime.jsxs)(StyledLink,{href:chapterFrontPageURL,children:[(0,jsx_runtime.jsx)(up_arrow_namespaceObject,{id:"up-svg-icon",role:"presentation",alt:""}),(0,jsx_runtime.jsx)("span",{children:t("chapter-front-page")})]}),(0,jsx_runtime.jsxs)(react.Fragment,{children:[(0,jsx_runtime.jsx)("h2",{className:emotion_css_esm.AH`
              font-size: clamp(28px, 3vw, 2rem);
              line-height: 1.3;
              font-weight: 600;
              opacity: 0.9;
              color: ${styles.$7.colors.gray[700]};
            `,children:title}),(0,jsx_runtime.jsx)("p",{className:emotion_css_esm.AH`
              font-size: 18px;
              color: ${styles.$7.colors.gray[700]};
              font-weight: 500;
              margin: 0.3rem 0;
            ...
            `,children:subtitle}),(0,jsx_runtime.jsxs)("div",{className:emotion_css_esm.AH`
              display: grid;
            ...
            `,children:[previous&&(0,jsx_runtime.jsx)(link_default(),{href:previous,"aria-label":t("previous-page"),children:(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.AH`
                  ...
                  `,children:(0,jsx_runtime.jsx)(backarrow_namespaceObject,{id:"back-arrow-icon",role:"presentation",alt:"",width:"25",height:"25",viewBox:"0 0 39 39"})})}),(0,jsx_runtime.jsx)(components_LinkOrNoLink,{url,linkClassName:emotion_css_esm.AH`
                overflow: hidden;
                text-decoration: none;
                &:focus-visible {
              ...
              `,children:(0,jsx_runtime.jsxs)("div",{className:emotion_css_esm.AH`
                ...
                `,children:[(0,jsx_runtime.jsxs)("div",{className:emotion_css_esm.AH`
                    background-color: ${url?styles.$7.colors.green[600]:styles.$7.colors.gray[600]};
                  ...
                  `,children:[(0,jsx_runtime.jsxs)("span",{className:"next-page-subtitle",children:[t("next-page"),":"]}),(0,jsx_runtime.jsx)("span",{className:"next-page-title",children:(0,jsx_runtime.jsx)(system_tests_HideTextInSystemTests,{text:nextTitle,testPlaceholder:"Title of the next page"})})]}),(0,jsx_runtime.jsx)("div",{className:emotion_css_esm.AH`
                    color: white;
