...
`,Footer=({licenseUrl})=>{const{t,i18n}=(0,es.$G)(),useFinnishLinks="fi"===i18n.language||"fi-FI"===i18n.language;return(0,jsx_runtime.jsx)("footer",{role:"contentinfo",className:emotion_css_esm.iv`
        margin-top: 2rem;
