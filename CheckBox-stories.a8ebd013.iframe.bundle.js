...
`,error=emotion_css_esm.AH`
  ...
  margin-top: -15px;
`,CheckBox=(0,react.forwardRef)((({onChangeByValue,onChange,className,checked,...rest},ref)=>(0,jsx_runtime.jsxs)("div",{className:(0,emotion_css_esm.cx)(emotion_css_esm.AH`
            margin-bottom: 1rem;
          `,className),children:[(0,jsx_runtime.jsxs)(Label,{children:[(0,jsx_runtime.jsx)("input",{type:"checkbox",checked,"aria-errormessage":rest.error?`${rest.label}_error`:void 0,"aria-invalid":void 0!==rest.error,onChange:event=>{if(onChangeByValue){const{target:{checked}}=event;onChangeByValue(checked)}onChange&&onChange(event)},ref,...rest}),(0,jsx_runtime.jsx)("span",{children:rest.label})]}),rest.error&&(0,jsx_runtime.jsx)("span",{className:rest.error?(0,emotion_css_esm.cx)(error):emotion_css_esm.AH`
                    visibility: hidden;
                    height: 0;
                    display: block;
...
//# sourceMappingURL=CheckBox-stories.a8ebd013.iframe.bundle.js.map