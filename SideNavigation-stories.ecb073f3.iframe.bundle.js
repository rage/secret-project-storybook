...
`,PlaceholderAvatar=emotion_styled_browser_esm.A.div`
  ...
  width: 34px;
  margin-right: 15px;
`,StyledButton=emotion_styled_browser_esm.A.button`
  display: flex;
  border: none;
