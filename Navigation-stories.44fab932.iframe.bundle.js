...
`,StyledLinesSpring=(0,emotion_styled_browser_esm.c)(StyledLines)`
  &::before {
...
`,StyledButton=emotion_styled_browser_esm.c.div`
...
`,navbarItems=emotion_css_esm.gV`
  position: relative;
  display: flex;
  height: 90px;
  align-items: center;
...
`,ComplexNav_active=emotion_css_esm.gV`
  left: 0;
  opacity: 1;
...
`,navLinks=emotion_css_esm.gV`
  ...
  &:after {
    ...
    bottom: 0;
    left: 0;
    background-color: ${styles.sn.colors.gray[700]};
...
`,hide=emotion_css_esm.gV`
  ${respond.e.lg} {
    display: none;
  }
`,secondaryLink=emotion_css_esm.gV`
  display: none;
  grid-gap: 10px;
  list-style: none;
  text-align: center;
...
`,components_SkipLink=SkipLink;try{SkipLink.displayName="SkipLink",SkipLink.__docgenInfo={description:"",displayName:"SkipLink",props:{theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"Theme"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"ElementType<any>"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/SkipLink.tsx#SkipLink"]={docgenInfo:SkipLink.__docgenInfo,name:"SkipLink",path:"src/components/SkipLink.tsx#SkipLink"})}catch(__react_docgen_typescript_loader_error){}const StyledIcon=emotion_css_esm.gV`
  font-size: 1.8rem;
  transform: scale(0.7);

  path {
    fill: ${styles.sn.colors.gray[600]} !important;
  }
`,Navbar=emotion_css_esm.gV`
  height: 90px;
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  ...
  font-size: 1rem;
  padding: 0 1.4rem;
  margin-bottom: ${constants.Sc};
  border-bottom: 2px solid ${styles.sn.colors.gray[100]};
