import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{Mt as r,Nt as i,Pt as a,mt as o}from"./iframe-DAw0MieJ.js";var s,c,l,u=t((()=>{a(),s=e(n()),c=o(),l=(0,s.forwardRef)(({id:e,label:t,onChangeByValue:n,onChange:a,onBlur:o,defaultValue:s,options:l,className:u,disabled:d,...f},p)=>(0,c.jsxs)(`div`,{className:i(r`
            margin-bottom: 1rem;
            ${d&&`opacity: 0.5;`}
            select {
              appearance: none;
