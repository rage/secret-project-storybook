import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{U as r,_ as i,dt as a,pt as o,t as s}from"./iframe-Byt8Om0O.js";function c(){let[e,t]=(0,l.useState)(`b`);return(0,u.jsx)(i,{label:`Controlled`,options:[{value:`a`,label:`Option A`},{value:`b`,label:`Option B`},{value:`c`,label:`Option C`}],value:e,onChange:e=>t(e.currentTarget.value)})}var l,u,d,f,p,m,h,g,_;t((()=>{o(),l=e(n()),s(),u=r(),d=a`
  display: grid;
  gap: 16px;
  max-width: 360px;
