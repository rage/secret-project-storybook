import{j as a,l as m,c as u}from"./iframe-D0P9lDOs.js";import"./preload-helper-Dp1pzeXC.js";const g=({onChange:e,onChangeByValue:n,className:d,...r})=>{const p=i=>{if(n){const{target:{value:c}}=i;n(c)}e&&e(i)};return a.jsx("div",{className:m(u`
          margin-bottom: 1rem;
