import{i as e}from"./preload-helper-B45gAKPr.js";import{Mt as t,Pt as n,lt as r,mt as i,rt as a,t as o,ut as s}from"./iframe-CnVUbaoj.js";function c({defaultSelectedKey:e=null,items:t,...n}){let{control:r}=s({defaultValues:{value:e}});return(0,l.jsx)(a,{name:`value`,control:r,getItemKey:e=>e.id,getItemTextValue:e=>e.label,items:t,...n,children:e=>e.label})}var l,u,d,f,p,m,h,g,_,v;e((()=>{n(),r(),o(),l=i(),u=t`
  display: grid;
  gap: 16px;
  max-width: 420px;
