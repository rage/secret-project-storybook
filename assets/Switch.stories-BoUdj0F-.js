import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{Dt as r,Tt as i,k as a,rt as o,t as s}from"./iframe-BvH-_XRD.js";function c(){let[e,t]=(0,l.useState)(!0);return(0,u.jsx)(a,{label:`Controlled (${e?`on`:`off`})`,checked:e,onChange:e=>t(e.currentTarget.checked)})}var l,u,d,f,p,m,h,g;t((()=>{r(),l=e(n()),s(),u=o(),d=i`
  display: grid;
  gap: 16px;
