import{i as e}from"./preload-helper-B45gAKPr.js";import{Dt as t,Tt as n,rt as r,t as i,tt as a}from"./iframe-BvH-_XRD.js";import{a as o,c as s,n as c,o as l,s as u}from"./atlas-icons-react-pULOn3e0.js";var d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{t(),s(),i(),d=r(),f=n`
  display: flex;
  gap: 12px;
  flex-wrap: wrap;
`,p=n`
  ...
  align-items: center;
  flex-wrap: wrap;
`,m={title:`Components/Button`,component:a,parameters:{docs:{description:{component:"Accessible button component built on React Aria with size/variant styling, icon slots, loading state, and `icon` variant for inline icon-only actions."}}},argTypes:{variant:{control:`select`,options:[`primary`,`secondary`,`tertiary`,`icon`]},size:{control:`select`,options:[`sm`,`md`,`lg`]}}},h={args:{variant:`primary`,size:`md`,children:`Button`}},g={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{variant:`primary`,children:`Primary`}),(0,d.jsx)(a,{variant:`secondary`,children:`Secondary`}),(0,d.jsx)(a,{variant:`tertiary`,children:`Tertiary`}),(0,d.jsx)(a,{variant:`icon`,"aria-label":`Icon action`,children:(0,d.jsx)(l,{"aria-hidden":`true`,size:16})})]})},_={render:()=>(0,d.jsxs)(`div`,{className:p,children:[(0,d.jsx)(a,{size:`sm`,children:`Small`}),(0,d.jsx)(a,{size:`md`,children:`Medium`}),(0,d.jsx)(a,{size:`lg`,children:`Large`})]})},v={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{isLoading:!0,loadingLabel:`Loading`,children:`Saving`}),(0,d.jsx)(a,{variant:`secondary`,isLoading:!0,loadingLabel:`Loading`,children:`Syncing`})]})},y={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{icon:(0,d.jsx)(l,{"aria-hidden":`true`,size:16}),iconPosition:`start`,children:`Starred`}),(0,d.jsx)(a,{icon:(0,d.jsx)(c,{"aria-hidden":`true`,size:16}),iconPosition:`end`,children:`Continue`})]})},b={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{disabled:!0,children:`Disabled`}),(0,d.jsx)(a,{variant:`secondary`,disabled:!0,children:`Disabled`}),(0,d.jsx)(a,{variant:`tertiary`,disabled:!0,children:`Disabled`})]})},x={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{variant:`icon`,size:`small`,"aria-label":`Delete item`,children:(0,d.jsx)(u,{"aria-hidden":`true`,size:18})}),(0,d.jsx)(a,{variant:`icon`,size:`small`,"aria-label":`Edit item`,children:(0,d.jsx)(o,{"aria-hidden":`true`,size:18})})]})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    variant: "primary",
    size: "md",
    children: "Button"
