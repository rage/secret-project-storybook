import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{U as r,_t as i,dt as a,ft as o,ht as s,pt as c}from"./iframe-CGsiV9X1.js";import{n as l,t as u}from"./emotion-styled.browser.esm-BprT3GlS.js";import{l as d,n as f,s as p,t as m}from"./styles-CBXWstuV.js";import{n as h,t as g}from"./strings-BQq8DVe-.js";var _,v,y,b,x,S,C,w,T=t((()=>{c(),u(),_=e(n()),s(),m(),p(),h(),v=r(),y=f.colors.red[600],b=`#dedede`,x=`padding: 8px 10px 10px 10px;`,S=l.input`
  background: #fcfcfc;
  border-width: 2px;
  border-style: solid;
  border-radius: 3px;
...
`,w=(0,_.forwardRef)(({onChange:e,onChangeByValue:t,className:n,disabled:r,error:s,...c},l)=>{let{t:u}=i();return(0,v.jsxs)(`div`,{className:o(a`
          ...
          `,n),children:[(0,v.jsxs)(`label`,{"aria-label":`${c.label}${c.required===!0&&` (${u(`required`)})`}`,className:o(a`
              ...
              ${r&&`cursor: not-allowed;`}
            `,c.labelStyle),children:[c.label&&(0,v.jsxs)(v.Fragment,{children:[c.label,` `,c.required===!0&&` *`]}),(0,v.jsx)(S,{id:c.id,name:c.name,disabled:r,type:`file`,"aria-errormessage":`${c.id??c.label}_error`,"aria-invalid":s!==void 0,onChange:n=>{if(t){let{target:{value:e}}=n;t(e)}e&&e(n)},error:g(s)??void 0,ref:l,...c})]}),(0,v.jsx)(`span`,{className:s?o(C):a`
                  visibility: hidden;
