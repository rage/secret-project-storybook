import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{Dt as r,Tt as i,q as a,rt as o,t as s}from"./iframe-BvH-_XRD.js";function c(){let[e,t]=(0,l.useState)(`beta`);return(0,u.jsx)(a,{getItemKey:e=>e.id,getItemTextValue:e=>e.label,label:`Controlled`,items:f,selectedKey:e,onSelectionChange:t,children:e=>e.label})}var l,u,d,f,p,m,h,g,_,v,y;t((()=>{r(),l=e(n()),s(),u=o(),d=i`
  display: grid;
  gap: 16px;
  max-width: 420px;
`,f=[{id:`alpha`,label:`Alpha`},{id:`beta`,label:`Beta`},{id:`gamma`,label:`Gamma`},{id:`delta`,label:`Delta`}],p=[{id:`long1`,label:`VeryLongOptionLabelWithoutSpacesThatShouldWrapInsideTheListboxPopoverWhenTheViewportOrTriggerIsNarrow`},{id:`long2`,label:`Short`}],m={title:`Components/ComboBox`,component:a},h={render:()=>(0,u.jsx)(a,{getItemKey:e=>e.id,getItemTextValue:e=>e.label,label:`Project`,items:f,children:e=>e.label})},g={render:()=>(0,u.jsxs)(`div`,{className:d,children:[(0,u.jsx)(a,{getItemKey:e=>e.id,getItemTextValue:e=>e.label,label:`Default`,items:f,children:e=>e.label}),(0,u.jsx)(a,{allowsCustomValue:!0,getItemKey:e=>e.id,getItemTextValue:e=>e.label,label:`Custom value`,items:f,children:e=>e.label}),(0,u.jsx)(a,{errorMessage:`Selection required`,getItemKey:e=>e.id,getItemTextValue:e=>e.label,label:`Invalid`,items:f,children:e=>e.label})]})},_={render:()=>(0,u.jsx)(c,{})},v={render:()=>(0,u.jsx)(`div`,{className:d,children:(0,u.jsx)(a,{getItemKey:e=>e.id,getItemTextValue:e=>e.label,label:`Project`,items:p,children:e=>e.label})})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
