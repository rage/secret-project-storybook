import{r as S,j as a,l as _,c as w}from"./iframe-D0P9lDOs.js";import"./preload-helper-Dp1pzeXC.js";const o=S.forwardRef(({id:e,label:i,onChangeByValue:s,onChange:d,onBlur:f,defaultValue:h,options:x,className:b,disabled:l,...p},y)=>{const v=t=>{if(s){const{target:{value:n}}=t;s(n)}d&&d(t)};return a.jsxs("div",{className:_(w`
            margin-bottom: 1rem;
            ${l&&"opacity: 0.5;"}
            select {
              appearance: none;
