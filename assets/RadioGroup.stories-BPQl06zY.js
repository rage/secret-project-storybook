import{y as r,j as e,z as a,c as v,r as R}from"./iframe-DXyIoFKT.js";import"./preload-helper-Dp1pzeXC.js";const g=v`
  display: grid;
  gap: 24px;
`,y={title:"Components/RadioGroup",component:r};function j(){const[x,b]=R.useState("alpha");return e.jsxs(r,{label:"Controlled",value:x,onChange:b,children:[e.jsx(a,{label:"Alpha",value:"alpha"}),e.jsx(a,{label:"Beta",value:"beta"})]})}const s={render:()=>e.jsxs(r,{label:"Theme",defaultValue:"light",children:[e.jsx(a,{label:"Light",value:"light"}),e.jsx(a,{label:"Dark",value:"dark"}),e.jsx(a,{label:"System",value:"system"})]})},l={render:()=>e.jsxs("div",{className:g,children:[e.jsxs(r,{label:"Delivery speed",errorMessage:"Choose one",children:[e.jsx(a,{label:"Standard",value:"standard"}),e.jsx(a,{label:"Express",value:"express"})]}),e.jsxs(r,{label:"Orientation",orientation:"horizontal",defaultValue:"left",children:[e.jsx(a,{label:"Left",value:"left"}),e.jsx(a,{label:"Right",value:"right"})]})]})},o={render:()=>e.jsx(j,{})};var t,n,i;s.parameters={...s.parameters,docs:{...(t=s.parameters)==null?void 0:t.docs,source:{originalSource:`{
...
} satisfies Story`,...(p=(u=l.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var c,m,h;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => <ControlledRadioGroupStory />
} satisfies Story`,...(h=(m=o.parameters)==null?void 0:m.docs)==null?void 0:h.source}}};const C=["Vertical","States","Controlled"];export{o as Controlled,l as States,s as Vertical,C as __namedExportsOrder,y as default};
