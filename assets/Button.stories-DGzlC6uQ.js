import{n as e}from"./chunk-jRWAZmH_.js";import{r as t,t as n}from"./emotion-css.esm-DyUfwQgn.js";import{C as r,S as i,t as a}from"./iframe-Dm9cNdLO.js";import{a as o,c as s,n as c,o as l,s as u}from"./atlas-icons-react-BLeh2dlk.js";var d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{t(),s(),a(),d=r(),f=n`
  display: flex;
  gap: 12px;
  flex-wrap: wrap;
`,p=n`
  ...
  align-items: center;
  flex-wrap: wrap;
`,m={title:`Components/Button`,component:i,parameters:{docs:{description:{component:"Accessible button component built on React Aria with size/variant styling, icon slots, loading state, and `icon` variant for inline icon-only actions."}}},argTypes:{variant:{control:`select`,options:[`primary`,`secondary`,`tertiary`,`icon`]},size:{control:`select`,options:[`sm`,`md`,`lg`]}}},h={args:{variant:`primary`,size:`md`,children:`Button`}},g={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(i,{variant:`primary`,children:`Primary`}),(0,d.jsx)(i,{variant:`secondary`,children:`Secondary`}),(0,d.jsx)(i,{variant:`tertiary`,children:`Tertiary`}),(0,d.jsx)(i,{variant:`icon`,"aria-label":`Icon action`,children:(0,d.jsx)(l,{"aria-hidden":`true`,size:16})})]})},_={render:()=>(0,d.jsxs)(`div`,{className:p,children:[(0,d.jsx)(i,{size:`sm`,children:`Small`}),(0,d.jsx)(i,{size:`md`,children:`Medium`}),(0,d.jsx)(i,{size:`lg`,children:`Large`})]})},v={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(i,{isLoading:!0,loadingLabel:`Loading`,children:`Saving`}),(0,d.jsx)(i,{variant:`secondary`,isLoading:!0,loadingLabel:`Loading`,children:`Syncing`})]})},y={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(i,{icon:(0,d.jsx)(l,{"aria-hidden":`true`,size:16}),iconPosition:`start`,children:`Starred`}),(0,d.jsx)(i,{icon:(0,d.jsx)(c,{"aria-hidden":`true`,size:16}),iconPosition:`end`,children:`Continue`})]})},b={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(i,{disabled:!0,children:`Disabled`}),(0,d.jsx)(i,{variant:`secondary`,disabled:!0,children:`Disabled`}),(0,d.jsx)(i,{variant:`tertiary`,disabled:!0,children:`Disabled`})]})},x={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(i,{variant:`icon`,size:`small`,"aria-label":`Delete item`,children:(0,d.jsx)(u,{"aria-hidden":`true`,size:18})}),(0,d.jsx)(i,{variant:`icon`,size:`small`,"aria-label":`Edit item`,children:(0,d.jsx)(o,{"aria-hidden":`true`,size:18})})]})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    variant: "primary",
    size: "md",
    children: "Button"
