import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{U as n,an as r,ct as i,ot as a,st as o}from"./iframe-DDfmRLCP.js";var s,c,l,u=t((()=>{i(),s=e(r()),c=n(),l=(0,s.forwardRef)(({id:e,label:t,onChangeByValue:n,onChange:r,onBlur:i,defaultValue:s,options:l,className:u,disabled:d,...f},p)=>(0,c.jsxs)(`div`,{className:o(a`
            margin-bottom: 1rem;
            ${d&&`opacity: 0.5;`}
            select {
              appearance: none;
