import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{Ft as r,Mt as i,Pt as a,mt as o}from"./iframe-DLEIRINA.js";import{n as s,t as c}from"./emotion-styled.browser.esm-JBkxDSkN.js";import{n as l,t as u,u as d}from"./styles-CBXWstuV.js";import{n as f,t as p}from"./respond-BfiaDCGD.js";var m,h,g,_,v,y=t((()=>{m=e(n()),h=o(),g=(0,m.createContext)(void 0),_=({children:e})=>{let t=(0,m.useRef)(new Set),n=(0,m.useCallback)(e=>{t.current.add(e)},[]),r=(0,m.useCallback)(e=>{t.current.delete(e)},[]),i=(0,m.useCallback)(()=>{t.current.forEach(e=>{e.open=!0})},[]),a=(0,m.useCallback)(()=>{t.current.forEach(e=>{e.open=!1})},[]),o=(0,m.useMemo)(()=>({expandAll:i,collapseAll:a,registerAccordion:n,unregisterAccordion:r}),[i,a,n,r]);return(0,h.jsx)(g.Provider,{value:o,children:e})},v=()=>{let e=(0,m.useContext)(g);if(!e)throw Error(`useAccordionContext must be used within an AccordionProvider`);return e}})),b,x,S,C,w,T,E=t((()=>{a(),c(),b=e(n()),u(),p(),y(),x=o(),S=r`
  0% { opacity: 0; }
  100% { opacity: 1; }
`,C=r`
