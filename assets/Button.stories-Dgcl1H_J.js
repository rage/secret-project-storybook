import{n as e}from"./chunk-jRWAZmH_.js";import{r as t,t as n}from"./emotion-css.esm-DyUfwQgn.js";import{C as r,S as i,t as a}from"./iframe-CIKWDTJj.js";import{a as o,n as s,o as c}from"./atlas-icons-react-B_7NjFc3.js";var l,u,d,f,p,m,h,g,_,v,y;e((()=>{t(),c(),a(),l=r(),u=n`
  display: flex;
  gap: 12px;
  flex-wrap: wrap;
`,d=n`
  ...
  align-items: center;
  flex-wrap: wrap;
`,f={title:`Components/Button`,component:i,parameters:{docs:{description:{component:`Accessible button component built on React Aria with size/variant styling, icon slots, and loading state.`}}},argTypes:{variant:{control:`select`,options:[`primary`,`secondary`,`tertiary`]},size:{control:`select`,options:[`sm`,`md`,`lg`]}}},p={args:{variant:`primary`,size:`md`,children:`Button`}},m={render:()=>(0,l.jsxs)(`div`,{className:u,children:[(0,l.jsx)(i,{variant:`primary`,children:`Primary`}),(0,l.jsx)(i,{variant:`secondary`,children:`Secondary`}),(0,l.jsx)(i,{variant:`tertiary`,children:`Tertiary`})]})},h={render:()=>(0,l.jsxs)(`div`,{className:d,children:[(0,l.jsx)(i,{size:`sm`,children:`Small`}),(0,l.jsx)(i,{size:`md`,children:`Medium`}),(0,l.jsx)(i,{size:`lg`,children:`Large`})]})},g={render:()=>(0,l.jsxs)(`div`,{className:u,children:[(0,l.jsx)(i,{isLoading:!0,loadingLabel:`Loading`,children:`Saving`}),(0,l.jsx)(i,{variant:`secondary`,isLoading:!0,loadingLabel:`Loading`,children:`Syncing`})]})},_={render:()=>(0,l.jsxs)(`div`,{className:u,children:[(0,l.jsx)(i,{icon:(0,l.jsx)(o,{"aria-hidden":`true`,size:16}),iconPosition:`start`,children:`Starred`}),(0,l.jsx)(i,{icon:(0,l.jsx)(s,{"aria-hidden":`true`,size:16}),iconPosition:`end`,children:`Continue`})]})},v={render:()=>(0,l.jsxs)(`div`,{className:u,children:[(0,l.jsx)(i,{disabled:!0,children:`Disabled`}),(0,l.jsx)(i,{variant:`secondary`,disabled:!0,children:`Disabled`}),(0,l.jsx)(i,{variant:`tertiary`,disabled:!0,children:`Disabled`})]})},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    variant: "primary",
    size: "md",
    children: "Button"
