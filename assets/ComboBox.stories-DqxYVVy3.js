import{i as e}from"./preload-helper-B45gAKPr.js";import{$ as t,St as n,et as r,it as i,q as a,t as o,wt as s}from"./iframe-CAN3q5_A.js";function c({defaultSelectedKey:e=null,items:t,...n}){let{control:i}=r({defaultValues:{value:e}});return(0,l.jsx)(a,{name:`value`,control:i,getItemKey:e=>e.id,getItemTextValue:e=>e.label,items:t,...n,children:e=>e.label})}var l,u,d,f,p,m,h,g,_,v;e((()=>{s(),t(),o(),l=i(),u=n`
  display: grid;
  gap: 16px;
  max-width: 420px;
