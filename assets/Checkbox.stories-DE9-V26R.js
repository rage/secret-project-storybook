import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{U as n,an as r,ct as i,ot as a,st as o}from"./iframe-B8-D29QV.js";import{n as s,t as c}from"./emotion-styled.browser.esm-En_VhDCN.js";import{l,n as u,t as d}from"./styles-CSQU3Qq8.js";var f,p,m,h,g,_,v,y,b=t((()=>{i(),c(),f=e(r()),d(),p=n(),m=`#F76D82`,h=`#787878`,g=s.label`
  font-family: ${l};
  font-size: 1.1rem;
  line-height: 1.1;
  display: grid;
...
`,_=a`
  ...
  margin-top: -15px;
`,v=`Please check the secret box`,y=(0,f.forwardRef)(({onChangeByValue:e,onChange:t,className:n,checked:r,labelIsRawHtml:i=!1,labelRef:s,...c},l)=>{let u=(0,f.useRef)(null),d=(0,f.useRef)(null);return(0,f.useEffect)(()=>{if(i&&!s&&u.current&&typeof window<`u`){let e=u.current,t=c.label;d.current!==t&&(e.innerHTML=t,d.current=t)}},[i,s,c.label]),(0,p.jsxs)(`div`,{className:o(a`
            margin-bottom: 1rem;
          `,n),children:[(0,p.jsxs)(g,{children:[(0,p.jsx)(`input`,{type:`checkbox`,checked:r,"aria-errormessage":c.error?`${c.label}_error`:void 0,"aria-invalid":c.error!==void 0,onChange:n=>{if(e){let{target:{checked:t}}=n;e(t)}t&&t(n)},ref:l,...c}),(0,p.jsx)(`span`,{ref:e=>{s&&(typeof s==`function`?s(e):s.current=e),u.current=e},children:i?void 0:c.label})]}),c.error&&(0,p.jsx)(`span`,{className:c.error?o(_):a`
                    visibility: hidden;
                    height: 0;
                    display: block;
