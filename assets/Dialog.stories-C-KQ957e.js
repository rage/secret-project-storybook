import{j as l}from"./jsx-runtime-CLpGMVip.js";import{c as E}from"./emotion-css.esm-HUuX3KNn.js";import{r as a}from"./index-BAAwwy_G.js";import{t as i}from"./typography-ksV1GOB1.js";import"./emotion-utils.browser.esm-D8RxJ_4a.js";const b=(d,t,s=!0)=>{const o=a.useRef(null);o.current=t,a.useEffect(()=>{if(!s)return;const c=u=>{var p,e;(p=d.current)!=null&&p.contains(u.target)||(e=o.current)==null||e.call(o,u)};return document.addEventListener("click",c,!0),()=>document.removeEventListener("click",c,!0)},[d,o,s])},f=({children:d,open:t,onClose:s,closeable:o=!0,noPadding:c=!1,width:u="normal",...p})=>{const e=a.useRef(null),h=a.useRef(null);return a.useEffect(()=>{const n=e.current,r=()=>{s&&s()};return n==null||n.addEventListener("close",r),()=>{n==null||n.removeEventListener("close",r)}},[s]),a.useEffect(()=>{e.current&&(t&&!e.current.open?e.current.showModal():e.current.open&&e.current.close())},[t]),a.useEffect(()=>{if(!e.current||o)return;const n=g=>{var v;g.cancelable||(v=e.current)==null||v.showModal(),g.preventDefault()},r=e.current;return r.addEventListener("close",n),r.addEventListener("cancel",n),()=>{r==null||r.removeEventListener("close",n),r==null||r.removeEventListener("cancel",n)}},[o]),b(h,()=>{var n;o&&((n=e.current)==null||n.close())},t),t?l.jsx("dialog",{ref:e,...p,className:E`
        border: 0;
        border-radius: 5px;
        padding: 0;
        width: 95%;
