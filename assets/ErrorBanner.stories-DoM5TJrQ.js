...
`})),Y,X,Ce=e((()=>{t(),n(),H(),ve(),be(),xe(),Se(),Y=i(),X=e=>{let{t}=r(),{variant:n=`text`,error:i,contextMessage:a,maxHeightVH:o,listMaxHeightVH:s}=e,c=n===`frontendCrash`,l=n===`frontendCrash`,u=_e(V(i,t),t),d=ye(i,t(`error-title`),t),f=d.status!==null&&d.status!==void 0?t(`error-status`,{status:d.status}):null,p=d.type?t(`error-type`,{type:d.type}):null,m=d.messageKey?t(`error-message-key-line`,{messageKey:d.messageKey}):null,h=d.code&&d.code!==d.type?t(`error-code`,{code:d.code}):null,g=d.technicalDetails?.method||d.technicalDetails?.url||d.technicalDetails?.detail||d.technicalDetails?.stack||d.technicalDetails?.raw!==void 0;return(0,Y.jsx)(G,{compact:c,isFrontendCrash:l,maxHeightVH:o,role:`alert`,children:(0,Y.jsxs)(K,{compact:c,children:[(0,Y.jsxs)(q,{compact:c,children:[(0,Y.jsx)(`h2`,{children:u.title}),a&&(0,Y.jsx)(`p`,{children:a}),u.message&&(0,Y.jsx)(`p`,{children:u.message}),!!d.issues?.length&&(0,Y.jsx)(`ul`,{children:d.issues.map((e,n)=>(0,Y.jsx)(`li`,{children:d.messageKey===`response_validation_error`?t(`error-zod-issue-prefix`,{path:e.path??``,message:e.message,defaultValue:`Validation issue at {{path}}: {{message}}`}):`${e.path?`${e.path}: `:``}${e.message}`},`${e.path??`issue`}-${n}`))})]}),(g||f||p||m||h||d.requestId||d.retryAfterSeconds!==null&&d.retryAfterSeconds!==void 0)&&(0,Y.jsx)(J,{listMaxHeightVH:s,children:(0,Y.jsxs)(`details`,{children:[(0,Y.jsx)(`summary`,{children:t(`show-error-source`)}),(0,Y.jsxs)(`ul`,{children:[f&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:f})}),d.requestId&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:t(`error-request-id`,{requestId:d.requestId})})}),d.retryAfterSeconds!==null&&d.retryAfterSeconds!==void 0&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:t(`error-retry-after`,{seconds:d.retryAfterSeconds})})}),p&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:p})}),m&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:m})}),h&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:h})}),d.technicalDetails?.method&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:t(`error-source-method`,{method:d.technicalDetails.method})})}),d.technicalDetails?.url&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:t(`error-source-url`,{url:d.technicalDetails.url})})}),d.technicalDetails?.detail&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:d.technicalDetails.detail})}),d.message&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:d.message})}),d.technicalDetails?.stack&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:d.technicalDetails.stack})}),d.technicalDetails?.raw!==void 0&&(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:d.technicalDetails.raw})})]}),!g&&d.sourceData!==void 0&&(0,Y.jsx)(`ul`,{children:(0,Y.jsx)(`li`,{children:(0,Y.jsx)(W,{text:d.sourceData})})})]})}),d.linkBlockId&&(0,Y.jsx)(q,{children:(0,Y.jsx)(`a`,{href:`${window.location.href.replace(location.hash,``)}#${d.linkBlockId}`,children:t(`go-to-error`)})})]})})}})),Z,Q,$;e((()=>{Ce(),Z={component:X,parameters:{docs:{description:{component:`Use this component to display an error banner. The error can be either a string or an Error object.`}}}},Q={args:{error:`This is an error message.`}},Q.parameters={...Q.parameters,docs:{...Q.parameters?.docs,source:{originalSource:`{
  args: {
