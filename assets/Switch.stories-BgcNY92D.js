import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{U as n,an as r,ct as i,h as a,ot as o,t as s}from"./iframe-CRYa-b-a.js";function c(){let[e,t]=(0,l.useState)(!0);return(0,u.jsx)(a,{label:`Controlled (${e?`on`:`off`})`,checked:e,onChange:e=>t(e.currentTarget.checked)})}var l,u,d,f,p,m,h,g;t((()=>{i(),l=e(r()),s(),u=n(),d=o`
  display: grid;
  gap: 16px;
