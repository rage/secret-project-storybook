import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{Dt as r,Et as i,Tt as a,rt as o}from"./iframe-BvH-_XRD.js";var s,c,l,u=t((()=>{r(),s=e(n()),c=o(),l=(0,s.forwardRef)(({id:e,label:t,onChangeByValue:n,onChange:r,onBlur:o,defaultValue:s,options:l,className:u,disabled:d,...f},p)=>(0,c.jsxs)(`div`,{className:i(a`
            margin-bottom: 1rem;
            ${d&&`opacity: 0.5;`}
            select {
              appearance: none;
