import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{r as t,t as n}from"./emotion-css.esm-DsoSFdsS.js";import{st as r,t as i}from"./components-BFIiifp_.js";import{t as a}from"./jsx-runtime-DeHZSEgm.js";import{d as o,f as s,m as c,n as l,p as u}from"./atlas-icons-react-CQxarVg9.js";var d,f,p,m,h,g,_,v,y,b,x,S;function C(){return(C=e((()=>{t(),c(),i(),d=a(),f=n`
  display: flex;
  gap: 12px;
  flex-wrap: wrap;
`,p=n`
  ...
  align-items: center;
  flex-wrap: wrap;
`,m={title:`Components/Button`,component:r,parameters:{docs:{description:{component:"Accessible button component built on React Aria with size/variant styling, icon slots, loading state, and `icon` variant for inline icon-only actions."}}},argTypes:{variant:{control:`select`,options:[`primary`,`secondary`,`tertiary`,`icon`]},size:{control:`select`,options:[`small`,`medium`,`large`]}}},h={args:{variant:`primary`,size:`medium`,children:`Button`}},g={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(r,{variant:`primary`,children:`Primary`}),(0,d.jsx)(r,{variant:`secondary`,children:`Secondary`}),(0,d.jsx)(r,{variant:`tertiary`,children:`Tertiary`}),(0,d.jsx)(r,{variant:`icon`,"aria-label":`Icon action`,children:(0,d.jsx)(s,{"aria-hidden":`true`,size:16})})]})},_={render:()=>(0,d.jsxs)(`div`,{className:p,children:[(0,d.jsx)(r,{size:`small`,children:`Small`}),(0,d.jsx)(r,{size:`medium`,children:`Medium`}),(0,d.jsx)(r,{size:`large`,children:`Large`})]})},v={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(r,{isLoading:!0,loadingLabel:`Loading`,children:`Saving`}),(0,d.jsx)(r,{variant:`secondary`,isLoading:!0,loadingLabel:`Loading`,children:`Syncing`})]})},y={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(r,{icon:(0,d.jsx)(s,{"aria-hidden":`true`,size:16}),iconPosition:`start`,children:`Starred`}),(0,d.jsx)(r,{icon:(0,d.jsx)(l,{"aria-hidden":`true`,size:16}),iconPosition:`end`,children:`Continue`})]})},b={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(r,{disabled:!0,children:`Disabled`}),(0,d.jsx)(r,{variant:`secondary`,disabled:!0,children:`Disabled`}),(0,d.jsx)(r,{variant:`tertiary`,disabled:!0,children:`Disabled`})]})},x={render:()=>(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(r,{variant:`icon`,size:`small`,"aria-label":`Delete item`,children:(0,d.jsx)(u,{"aria-hidden":`true`,size:18})}),(0,d.jsx)(r,{variant:`icon`,size:`small`,"aria-label":`Edit item`,children:(0,d.jsx)(o,{"aria-hidden":`true`,size:18})})]})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    variant: "primary",
    size: "medium",
    children: "Button"
