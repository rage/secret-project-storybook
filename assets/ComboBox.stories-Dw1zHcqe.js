import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{N as r,U as i,dt as a,pt as o,t as s}from"./iframe-CGsiV9X1.js";function c(){let[e,t]=(0,l.useState)(`beta`);return(0,u.jsx)(r,{getItemKey:e=>e.id,getItemTextValue:e=>e.label,label:`Controlled`,items:f,selectedKey:e,onSelectionChange:t,children:e=>e.label})}var l,u,d,f,p,m,h,g,_,v,y;t((()=>{o(),l=e(n()),s(),u=i(),d=a`
  display: grid;
  gap: 16px;
  max-width: 420px;
