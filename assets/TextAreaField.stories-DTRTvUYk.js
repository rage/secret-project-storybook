import{r as u,j as d,l as _,c as w,R as j}from"./iframe-D0P9lDOs.js";import"./preload-helper-Dp1pzeXC.js";function p(e,r,a){if(e.current){const t=e.current.style.height;e.current.style.height="auto";const g=`${e.current.scrollHeight+5}px`;a&&e.current.scrollHeight>a?e.current.style.height=`${a}px`:e.current.style.height=`${e.current.scrollHeight+5}px`,r&&t!==g&&r()}}const C=(e,r)=>(j.useEffect(()=>{[r,e].forEach(a=>{a&&(typeof a=="function"?a(r.current||null):a.current=r.current||null)})},[r,e]),r),m=u.forwardRef(({onChangeByValue:e,onChange:r,className:a,autoResize:t,resize:g="vertical",onAutoResized:l,autoResizeMaxHeightPx:n,...s},x)=>{const o=u.useRef(null),E=C(x,o),h=u.useRef(s.value),V=c=>{if(e){const{target:{value:i}}=c;e(i)}r&&r(c),t&&p(o,l,n)};return u.useEffect(()=>{t&&p(o,l,n)},[t,l,n]),u.useEffect(()=>{t&&(h.current&&s.value!=h.current&&p(o,l,n),h.current=s.value)},[s.value,t,l,n]),u.useEffect(()=>{const c=new IntersectionObserver(T=>{for(const q of T)if(q.isIntersecting&&o.current){p(o,l,n);break}}),i=o.current;return i&&c.observe(i),()=>{i&&c.disconnect()}},[l,n]),d.jsx("div",{className:_(w`
            margin-bottom: 1rem;
...
} satisfies StoryType`,...(y=(b=f.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};const S=["Example"];export{f as Example,S as __namedExportsOrder,N as default};
