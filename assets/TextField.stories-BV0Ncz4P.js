import{n as e}from"./chunk-jRWAZmH_.js";import{r as t,t as n}from"./emotion-css.esm-DyUfwQgn.js";import{C as r,b as i,s as a,t as o,x as s}from"./iframe-CIKWDTJj.js";import{i as c,n as l,o as u}from"./atlas-icons-react-B_7NjFc3.js";var d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{t(),u(),i(),o(),d=r(),f=n`
  display: flex;
...
`,p=n`
  ...
  flex-wrap: wrap;
  gap: 16px;
`,m={title:`Components/TextField`,component:a,parameters:{docs:{description:{component:"Floating-label text field built on React Aria `useTextField`, with size variants, description/error messaging, and optional start/end icons."}}},argTypes:{type:{control:`select`,options:[`text`,`email`,`password`]},fieldSize:{control:`select`,options:[`sm`,`md`,`lg`]}}},h={render:()=>{let{control:e}=s({defaultValues:{email:``}});return(0,d.jsx)(a,{name:`email`,control:e,label:`Email`,type:`email`,fieldSize:`md`,description:`We'll only use this for account updates.`,placeholder:`ignored in floating-label mode`,isRequired:!0})}},g={render:()=>{let{control:e}=s({defaultValues:{default:``,description:``,error:``,disabled:``,readonly:`Read-only value`}});return(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{name:`default`,control:e,label:`Default`}),(0,d.jsx)(a,{name:`description`,control:e,label:`With description`,description:`Helper text goes here.`}),(0,d.jsx)(a,{name:`error`,control:e,label:`With error`,errorMessage:`This field is required.`}),(0,d.jsx)(a,{name:`disabled`,control:e,label:`Disabled`,isDisabled:!0}),(0,d.jsx)(a,{name:`readonly`,control:e,label:`Read only`,isReadOnly:!0})]})}},_={render:()=>{let{control:e}=s({defaultValues:{small:``,medium:``,large:``}});return(0,d.jsxs)(`div`,{className:p,children:[(0,d.jsx)(a,{name:`small`,control:e,label:`Small`,fieldSize:`sm`}),(0,d.jsx)(a,{name:`medium`,control:e,label:`Medium`,fieldSize:`md`}),(0,d.jsx)(a,{name:`large`,control:e,label:`Large`,fieldSize:`lg`})]})}},v={render:()=>{let{control:e}=s({defaultValues:{email:``,search:``}});return(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{name:`email`,control:e,label:`Email`,type:`email`,iconStart:(0,d.jsx)(c,{"aria-hidden":`true`,size:16}),description:`Leading icon with floating label.`}),(0,d.jsx)(a,{name:`search`,control:e,label:`Search`,type:`search`,iconEnd:(0,d.jsx)(l,{"aria-hidden":`true`,size:16}),description:`Trailing icon with floating label.`})]})}},y={render:()=>{let{control:e}=s({defaultValues:{defaultValue:`Prefilled value`,controlledValue:`Controlled value`}});return(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{name:`defaultValue`,control:e,label:`Default value`}),(0,d.jsx)(a,{name:`controlledValue`,control:e,label:`Controlled value`})]})}},b=`VeryLongUnbrokenLabelStringThatShouldWrapGracefullyInNarrowLayoutsWithoutOverflowingTheViewportHorizontally`,x={render:()=>{let{control:e}=s({defaultValues:{longDescription:``,longError:``}});return(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(a,{name:`longDescription`,control:e,label:b,description:`Helper text that is intentionally long so description wrapping can be reviewed at narrow widths.`}),(0,d.jsx)(a,{name:`longError`,control:e,label:`Label`,errorMessage:`Error text that is intentionally long so error wrapping can be reviewed at narrow widths without horizontal overflow.`})]})}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: () => {
    const {
      control
    } = useForm<{
