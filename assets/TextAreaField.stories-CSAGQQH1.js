import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{Ct as r,St as i,it as a,wt as o}from"./iframe-CAN3q5_A.js";import{n as s,t as c}from"./styles-CBXWstuV.js";function l(e,t,n){if(e.current){let r=e.current.style.height;e.current.style.height=`auto`;let i=`${e.current.scrollHeight+5}px`;n&&e.current.scrollHeight>n?e.current.style.height=`${n}px`:e.current.style.height=`${e.current.scrollHeight+5}px`,t&&r!==i&&t()}}var u,d,f,p,m=t((()=>{o(),u=e(n()),c(),d=a(),f=(e,t)=>(u.useEffect(()=>{[t,e].forEach(e=>{e&&(typeof e==`function`?e(t.current||null):e.current=t.current||null)})},[t,e]),t),p=(0,u.forwardRef)(({onChangeByValue:e,onChange:t,className:n,autoResize:a,resize:o=`vertical`,onAutoResized:c,autoResizeMaxHeightPx:p,...m},h)=>{let g=(0,u.useRef)(null),_=f(h,g),v=(0,u.useRef)(m.value),y=(0,u.useId)(),b=m.label?y:void 0,x=m[`aria-labelledby`]!==void 0||m[`aria-label`]!==void 0?m[`aria-labelledby`]:b;return(0,u.useEffect)(()=>{a&&l(g,c,p)},[a,c,p]),(0,u.useEffect)(()=>{a&&(v.current&&m.value!==v.current&&l(g,c,p),v.current=m.value)},[m.value,a,c,p]),(0,u.useEffect)(()=>{let e=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting&&g.current){l(g,c,p);break}}),t=g.current;return t&&e.observe(t),()=>{t&&e.disconnect()}},[c,p]),(0,d.jsx)(`div`,{className:r(i`
            margin-bottom: 1rem;
