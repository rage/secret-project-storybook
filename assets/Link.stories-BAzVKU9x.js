import{n as e}from"./chunk-jRWAZmH_.js";import{r as t,t as n}from"./emotion-css.esm-DyUfwQgn.js";import{C as r,m as i,t as a}from"./iframe-Dm9cNdLO.js";import{c as o,n as s}from"./atlas-icons-react-BLeh2dlk.js";var c,l,u,d,f,p,m,h,g,_,v;e((()=>{t(),o(),a(),c=r(),l=n`
  display: flex;
  gap: 12px;
  flex-wrap: wrap;
`,u=n`
  ...
  align-items: center;
  flex-wrap: wrap;
`,d={title:`Components/Link`,component:i,parameters:{docs:{description:{component:"Accessible link component built on React Aria with optional button styling, loading state, and icon slots. When `styledAsButton` is set, padding, variants, and sizes use the same `buttonStyles` primitives as `Button` for visual parity."}}},argTypes:{variant:{control:`select`,options:[`primary`,`secondary`,`tertiary`]},size:{control:`select`,options:[`sm`,`md`,`lg`]}}},f={args:{href:`/`,children:`Visit homepage`}},p={args:{href:`/`,styledAsButton:!0,variant:`primary`,size:`md`,icon:(0,c.jsx)(s,{"aria-hidden":`true`,size:16}),iconPosition:`start`,children:`Open`}},m={render:()=>(0,c.jsxs)(`div`,{className:l,children:[(0,c.jsx)(i,{href:`/`,styledAsButton:!0,variant:`primary`,children:`Primary`}),(0,c.jsx)(i,{href:`/`,styledAsButton:!0,variant:`secondary`,children:`Secondary`}),(0,c.jsx)(i,{href:`/`,styledAsButton:!0,variant:`tertiary`,children:`Tertiary`})]})},h={render:()=>(0,c.jsxs)(`div`,{className:u,children:[(0,c.jsx)(i,{href:`/`,styledAsButton:!0,size:`sm`,children:`Small`}),(0,c.jsx)(i,{href:`/`,styledAsButton:!0,size:`md`,children:`Medium`}),(0,c.jsx)(i,{href:`/`,styledAsButton:!0,size:`lg`,children:`Large`})]})},g={render:()=>(0,c.jsxs)(`div`,{className:l,children:[(0,c.jsx)(i,{href:`/`,styledAsButton:!0,isLoading:!0,loadingLabel:`Loading`,children:`Loading`}),(0,c.jsx)(i,{href:`/`,styledAsButton:!0,variant:`secondary`,isLoading:!0,loadingLabel:`Loading`,children:`Loading`})]})},_={render:()=>(0,c.jsxs)(`div`,{className:l,children:[(0,c.jsx)(i,{href:`/`,styledAsButton:!0,isDisabled:!0,children:`Disabled`}),(0,c.jsx)(i,{href:`/`,styledAsButton:!0,variant:`secondary`,isDisabled:!0,children:`Disabled`}),(0,c.jsx)(i,{href:`/`,styledAsButton:!0,variant:`tertiary`,isDisabled:!0,children:`Disabled`})]})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    href: "/",
