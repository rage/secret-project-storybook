import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{Mt as r,Nt as i,Pt as a,mt as o}from"./iframe-BCr5gq3W.js";import{n as s,t as c}from"./emotion-styled.browser.esm-DHjO5iYq.js";import{l,n as u,s as d,t as f}from"./styles-CBXWstuV.js";import{n as p,t as m}from"./strings-BQq8DVe-.js";var h,g,_,v,y,b,x,S,C=t((()=>{a(),c(),h=e(n()),f(),d(),p(),g=o(),_=u.colors.red[600],v=u.colors.gray[400],y=`padding: 8px 10px 10px 10px;`,b=s.input`
  background: #fcfcfc;
  border-width: 2px;
  border-style: solid;
  border-radius: 3px;
...
`,S=(0,h.forwardRef)(({onChange:e,onChangeByValue:t,className:n,disabled:a,error:o,...s},c)=>(0,g.jsxs)(`div`,{className:i(r`
            margin-bottom: 1rem;
            ${a&&`cursor: not-allowed;
            filter: opacity(0.5);`}
          `,n),children:[(0,g.jsxs)(`label`,{className:i(r`
              color: #333;
              font-family: ${l};
              font-weight: 500;
              font-size: 14px;
