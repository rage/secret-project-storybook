import{i as e}from"./preload-helper-B45gAKPr.js";import{B as t,U as n,dt as r,p as i,pt as a,t as o,z as s}from"./iframe-C_WWdr09.js";import{c,t as l}from"./atlas-icons-react-pULOn3e0.js";var u,d,f,p,m,h,g,_,v;e((()=>{a(),c(),s(),o(),u=n(),d=r`
  display: flex;
...
`,f=r`
  ...
  flex-wrap: wrap;
  gap: 16px;
`,p={title:`Components/TextArea`,component:i},m={render:()=>{let{control:e}=t({defaultValues:{a:``}});return(0,u.jsx)(i,{name:`a`,control:e,label:`Bio`,fieldSize:`md`,rows:3,description:`Tell us a little bit about yourself.`,autoResize:!0})}},h={render:()=>{let{control:e}=t({defaultValues:{a:``,b:``,c:`Read-only content`}});return(0,u.jsxs)(`div`,{className:d,children:[(0,u.jsx)(i,{name:`a`,control:e,label:`Default`,rows:3}),(0,u.jsx)(i,{name:`b`,control:e,label:`With description`,description:`Helper text goes here.`,rows:3}),(0,u.jsx)(i,{name:`a`,control:e,label:`With error`,errorMessage:`Too short.`,rows:3}),(0,u.jsx)(i,{name:`a`,control:e,label:`Disabled`,isDisabled:!0,rows:3}),(0,u.jsx)(i,{name:`c`,control:e,label:`Read only`,isReadOnly:!0,rows:3})]})}},g={render:()=>{let{control:e}=t({defaultValues:{a:``,b:``,c:``}});return(0,u.jsxs)(`div`,{className:f,children:[(0,u.jsx)(i,{name:`a`,control:e,label:`Small`,fieldSize:`sm`,rows:3}),(0,u.jsx)(i,{name:`b`,control:e,label:`Medium`,fieldSize:`md`,rows:3}),(0,u.jsx)(i,{name:`c`,control:e,label:`Large`,fieldSize:`lg`,rows:3})]})}},_={render:()=>{let{control:e}=t({defaultValues:{a:``}});return(0,u.jsx)(`div`,{className:d,children:(0,u.jsx)(i,{name:`a`,control:e,label:`Notes`,description:`Leading icon anchored to the label baseline.`,iconStart:(0,u.jsx)(l,{"aria-hidden":`true`,size:16}),rows:4})})}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => {
    const {
      control
    } = useForm<Form>({
