import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{U as n,an as r,ct as i,lt as a,ot as o}from"./iframe-B8-D29QV.js";import{n as s,t as c}from"./emotion-styled.browser.esm-En_VhDCN.js";import{n as l,t as u,u as d}from"./styles-CSQU3Qq8.js";import{n as f,t as p}from"./respond-CElc44Sa.js";var m,h,g,_,v,y=t((()=>{m=e(r()),h=n(),g=(0,m.createContext)(void 0),_=({children:e})=>{let t=(0,m.useRef)(new Set),n=(0,m.useCallback)(e=>{t.current.add(e)},[]),r=(0,m.useCallback)(e=>{t.current.delete(e)},[]),i=(0,m.useCallback)(()=>{t.current.forEach(e=>{e.open=!0})},[]),a=(0,m.useCallback)(()=>{t.current.forEach(e=>{e.open=!1})},[]),o=(0,m.useMemo)(()=>({expandAll:i,collapseAll:a,registerAccordion:n,unregisterAccordion:r}),[i,a,n,r]);return(0,h.jsx)(g.Provider,{value:o,children:e})},v=()=>{let e=(0,m.useContext)(g);if(!e)throw Error(`useAccordionContext must be used within an AccordionProvider`);return e}})),b,x,S,C,w,T,E=t((()=>{i(),c(),b=e(r()),u(),p(),y(),x=n(),S=a`
  0% { opacity: 0; }
  100% { opacity: 1; }
`,C=a`
