import{j as a,l as m,c as u}from"./iframe-D0P9lDOs.js";import"./preload-helper-Dp1pzeXC.js";const g=({onChangeByValue:e,onChange:i,className:s,...t})=>{const p=r=>{if(e){const{target:{value:c}}=r;e(c)}i&&i(r)};return a.jsx("div",{className:m(u`
          margin-bottom: 1rem;
