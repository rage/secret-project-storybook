import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-BZJXY1be.js";import{a as r,r as i,t as a}from"./emotion-css.esm-DsoSFdsS.js";import{t as o}from"./jsx-runtime-DeHZSEgm.js";import{n as s,t as c}from"./emotion-styled.browser.esm-Da19Zo8Q.js";import{n as l,t as u,u as d}from"./styles-CJhTCqa4.js";import{n as f,t as p}from"./respond-Bh2VEMCT.js";var m,h,g,_,v;function y(){return(y=t((()=>{m=e(n()),h=o(),g=(0,m.createContext)(void 0),_=({children:e})=>{let t=(0,m.useRef)(new Set),n=(0,m.useCallback)(e=>{t.current.add(e)},[]),r=(0,m.useCallback)(e=>{t.current.delete(e)},[]),i=(0,m.useCallback)(()=>{t.current.forEach(e=>{e.open=!0})},[]),a=(0,m.useCallback)(()=>{t.current.forEach(e=>{e.open=!1})},[]),o=(0,m.useMemo)(()=>({expandAll:i,collapseAll:a,registerAccordion:n,unregisterAccordion:r}),[i,a,n,r]);return(0,h.jsx)(g.Provider,{value:o,children:e})},v=()=>{let e=(0,m.useContext)(g);if(!e)throw Error(`useAccordionContext must be used within an AccordionProvider`);return e}})))()}var b,x,S,C,w,T;function E(){return(E=t((()=>{i(),c(),b=e(n()),u(),p(),y(),x=o(),S=r`
  0% { opacity: 0; }
  100% { opacity: 1; }
`,C=r`
...
} satisfies StoryType`,...M.parameters?.docs?.source}}},N=[`Accordion`,`OpenByDefault`,`WithExpandCollapseControls`]})))()}P();export{k as Accordion,A as OpenByDefault,M as WithExpandCollapseControls,N as __namedExportsOrder,O as default};