import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{c as m,a as u}from"./emotion-css.esm-BvLEAwLp.js";import"./emotion-utils.browser.esm-YKnV_D65.js";const g=({onChange:e,onChangeByValue:n,className:d,...r})=>{const p=i=>{if(n){const{target:{value:c}}=i;n(c)}e&&e(i)};return a.jsx("div",{className:m(u`
          margin-bottom: 1rem;
