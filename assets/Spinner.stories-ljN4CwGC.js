import{s as Y,r as j,j as B}from"./iframe-DXyIoFKT.js";import{h as G,E as Q,c as Z,s as k}from"./emotion-styled.browser.esm-D3ju6Bg2.js";import{b as O}from"./theme-DgIg-lup.js";import"./preload-helper-Dp1pzeXC.js";import"./extends-CF3RwP-h.js";var M={exports:{}},t={};/** @license React v16.13.1
...
`,R=r=>B.jsx(se,{"data-testid":"spinner",className:oe,...r});try{R.displayName="Spinner",R.__docgenInfo={description:"",displayName:"Spinner",props:{variant:{defaultValue:null,description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:'"placeholder"'},{value:'"large"'},{value:'"medium"'},{value:'"small"'}]}},disableMargin:{defaultValue:null,description:"",name:"disableMargin",required:!1,type:{name:"boolean"}}}}}catch{}const de={component:R,parameters:{docs:{description:{component:"Used to display a loading animation."}}}},w={args:{variant:"medium",disableMargin:!1}},P={args:{variant:"small"}},T={args:{variant:"large"}};var z,C,D;w.parameters={...w.parameters,docs:{...(z=w.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    variant: "medium",
    disableMargin: false
  }
