import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{r as t,t as n}from"./emotion-css.esm-DsoSFdsS.js";import{W as r,at as i,it as a,t as o}from"./components-BFIiifp_.js";import{t as s}from"./jsx-runtime-DeHZSEgm.js";function c(){let{control:e}=i({defaultValues:{code:`123`}});return(0,d.jsx)(r,{name:`code`,control:e,label:`Verification code`,length:6})}function l(){let{control:e}=i({defaultValues:{code:``}}),{control:t}=i({defaultValues:{code:``}}),{control:n}=i({defaultValues:{code:`123456`}});return(0,d.jsxs)(`div`,{className:f,children:[(0,d.jsx)(r,{name:`code`,control:e,label:`Default`}),(0,d.jsx)(r,{name:`code`,control:t,label:`Invalid`,errorMessage:`Code is required`}),(0,d.jsx)(r,{name:`code`,control:n,label:`Disabled`,isDisabled:!0})]})}function u(){let{control:e}=i({defaultValues:{code:`123`}});return(0,d.jsx)(r,{name:`code`,control:e,label:`Controlled`})}var d,f,p,m,h,g,_;function v(){return(v=e((()=>{t(),a(),o(),d=s(),f=n`
  display: grid;
  gap: 16px;
  max-width: 420px;
