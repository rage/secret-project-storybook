import{i as e}from"./preload-helper-B45gAKPr.js";import{St as t,i as n,it as r,t as i,wt as a}from"./iframe-CAN3q5_A.js";function o(e){return{data:void 0,error:null,isError:!1,isPending:!1,isRefetching:!1,refetch:()=>Promise.resolve({}),...e}}var s,c,l,u,d,f,p,m,h,g,_,v,y,b;e((()=>{a(),i(),s=r(),c=t`
  margin: 0;
`,l={title:`Components/QueryResult`,parameters:{docs:{description:{component:"Wraps TanStack Query results with loading skeletons, refetch progress, stale errors, and empty states. Loaded content renders layout-neutral (no clipping frame), while loading/error chrome is applied only for those states. Pass `themeMode` from the host app (light/dark)."}}}},u={render:()=>(0,s.jsx)(n,{themeMode:`light`,query:o({data:`Loaded content`,isPending:!1}),children:e=>(0,s.jsx)(`p`,{className:c,children:e})})},d={render:()=>(0,s.jsx)(n,{themeMode:`light`,loadingDelayMs:0,query:o({data:void 0,isPending:!0}),children:()=>null})},f={render:()=>(0,s.jsx)(n,{themeMode:`light`,query:o({data:void 0,isPending:!1,isError:!0,error:Error(`Request failed`)}),children:()=>null})},p={render:()=>(0,s.jsx)(n,{themeMode:`light`,query:o({data:`Stale content still visible`,isPending:!1,isError:!0,error:Error(`Background refetch failed`)}),children:e=>(0,s.jsx)(`p`,{className:c,children:e})})},m={render:()=>(0,s.jsx)(n,{themeMode:`light`,query:o({data:`Content while refetching`,isPending:!1,isFetching:!0,isRefetching:!0}),children:e=>(0,s.jsx)(`p`,{className:c,children:e})})},h={render:()=>(0,s.jsx)(n,{themeMode:`light`,query:o({data:[],isPending:!1}),emptyFallback:(0,s.jsx)(`p`,{className:c,children:`No rows yet.`}),children:e=>(0,s.jsx)(`p`,{className:c,children:e.join(`,`)})})},g={render:()=>(0,s.jsx)(n,{themeMode:`dark`,query:o({data:`Loaded in dark theme`,isPending:!1}),children:e=>(0,s.jsx)(`p`,{className:c,children:e})})},_=t`
  width: 100%;
