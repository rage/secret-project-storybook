import{s as F,r as R,j as z}from"./iframe-CJ3_LdV8.js";import{h as C,E as D,c as J,s as L}from"./emotion-styled.browser.esm-CumKfT5o.js";import{b as w}from"./theme-DgIg-lup.js";var P={exports:{}},t={};/** @license React v16.13.1
...
`,N={small:{width:"16px",height:"16px"},medium:{width:"30px",height:"30px"},large:{width:"42px",height:"42px"},placeholder:{width:"30px",height:"30px"}},G=L.div`
...
`,A=r=>z.jsx(G,{"data-testid":"spinner",className:K,...r});try{A.displayName="Spinner",A.__docgenInfo={description:"",displayName:"Spinner",props:{variant:{defaultValue:null,description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:'"large"'},{value:'"medium"'},{value:'"small"'},{value:'"placeholder"'}]}},disableMargin:{defaultValue:null,description:"",name:"disableMargin",required:!1,type:{name:"boolean"}}}}}catch{}export{A as S};
