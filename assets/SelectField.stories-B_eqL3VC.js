import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{U as r,dt as i,ft as a,pt as o}from"./iframe-Cwq9EqjE.js";var s,c,l,u=t((()=>{o(),s=e(n()),c=r(),l=(0,s.forwardRef)(({id:e,label:t,onChangeByValue:n,onChange:r,onBlur:o,defaultValue:s,options:l,className:u,disabled:d,...f},p)=>(0,c.jsxs)(`div`,{className:a(i`
            margin-bottom: 1rem;
            ${d&&`opacity: 0.5;`}
            select {
              appearance: none;
